...
// SEC 004 Sport ACCOUNT ADAPTED FOR DEMO PURPOSES, CHANGED NAMES IN MY MEMBERS SECTION, ADDED DEMO DASHBOARD LINKS
...
// 1A. LOGIN SCHREEN
const ACCOUNT_NAME = "SPORTSEYE STATE DEMO"
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1uTd_NYEdcGLilvoa5UNC1PZfU31bEg7r/page/HbFMB" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_mem_dashboard_performance = `
<h1>SPORT PERFORMANCE DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1nfR97ltqH2q7g_31NfSSLDnnZwzUgmKA/page/mZ1r" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_mem_dashboard_wellbeing = `
<h1>HEALTH & WELLBEING DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/17A8kr2MOLXrWJGHvU4PpK3BxrUIlzrgk/page/J8YJB" frameborder="0" style="border:0" allowfullscreen></iframe>
`
            ...
            layers: [
              {
                ...
                legendText: 'Sport Members in SA2 Area',
                // click: TBC,
              ...
              },
              {
                ...
                name: 'LGA',
                legendText: 'Sport Members in LGA Area',
                // click: TBC,
                hover: module_mem_sec_004_squa_area_popup_hover
              },
              {
                ...
                name: 'REGION',
                legendText: 'Sport Members in Govt. Region',
                // click: TBC,
                hover: module_mem_sec_004_squa_area_popup_hover
              },
            ]
            ...
            layers: [
              {
                ...
                legendText: 'Sport Demand in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_004_squa_area_popup_hover
              },
              {
                ...
                name: 'LGA',
                legendText: 'Sport Demand in LGA Area',
                // click: TBC,
                hover: module_mem_sec_004_squa_area_popup_hover
              },
              {
                ...
                name: 'REGION',
                legendText: 'Sport Demand in Govt. Region',
                // click: TBC,
                hover: module_mem_sec_004_squa_area_popup_hover
              },
            ]
            ...
            layers: [
              {
                ...
                legendText: 'Sport Demand Conversion (%) in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_004_squa_area_popup_hover
              },
              {
                ...
                name: 'LGA',
                legendText: 'Sport Demand Conversion (%) in LGA Area',
                // click: TBC,
                hover: module_mem_sec_004_squa_area_popup_hover
              },
              {
                ...
                name: 'REGION',
                legendText: 'Sport Demand Conversion (%) in Govt. Region',
                // click: TBC,
                hover: module_mem_sec_004_squa_area_popup_hover
              },
            ]
            ...
            layers: [
              {
                ...
                legendText: 'Sport Clubs and Members at Site',
                // click: TBC,
