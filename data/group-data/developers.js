...
// THE FOLLOWING ACCOUNT IS USED FOR DEVELOPMENT PURPOSES ONLY
...
// 1A. LOGIN SCHREEN
const ACCOUNT_NAME = "DEVELOPER ACCOUNT"
...
<h4>{AREA_NAME}</h4>
<p>1. Members</p>
<h4>{seo_000_mem_all}</h4>
<p>2. Demand</p>
<h4>{se_leisure_dem}</h4>
<p>3. Conversion</p>
<h4>{seo_000_mem_dem_cnv_all}%</h4>
`
...
<h4>{AREA_NAME}</h4>
<p>1. Members</p>
<h4>{seo_000_mem_swm}</h4>
<p>2. Demand</p>
<h4>{se_swim_dem}</h4>
<p>3. Conversion</p>
<h4>{seo_000_mem_dem_cnv_swm}%</h4>
`
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              ...
              {
                name: 'SA2 (NZ)',
                id: 'seo_000_mem_all_nz_SA2',
                legendText: module_mem_submodule1_section2_layer1_legendText,
                hover: module_mem_submodule1_sectionall_layers_area_popup_hover,
              },
              {
                id: 'seo_000_mem_all_nz_LGA',
                name: 'TA (NZ)',
                legendText: module_mem_submodule1_section2_layer2_legendText,
                hover: module_mem_submodule1_sectionall_layers_area_popup_hover,
              },
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'seo_000_mem_dem_cnv_all_SA2',
                legendText: module_mem_submodule1_section4_layer1_legendText,
                hover: module_mem_submodule1_sectionall_layers_area_popup_hover,
              },
              {
                id: 'seo_000_mem_dem_cnv_all_LGA',
                name: 'LGA',
              ...
              {
                name: 'SA2 (NZ)',
                id: 'seo_000_mem_dem_cnv_all_nz_SA2',
                legendText: module_mem_submodule1_section4_layer1_legendText,
                hover: module_mem_submodule1_sectionall_layers_area_popup_hover,
              },
              {
                id: 'seo_000_mem_dem_cnv_all_nz_LGA',
                name: 'TA (NZ)',
                legendText: module_mem_submodule1_section4_layer2_legendText,
                hover: module_mem_submodule1_sectionall_layers_area_popup_hover,
              },
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              ...
              {
                name: 'SA2 (NZ)',
                id: 'seo_000_mem_swm_nz_SA2',
                legendText: module_mem_submodule2_section2_layer1_legendText,
                hover: module_mem_submodule2_sectionall_layers_area_popup_hover,
              },
              {
                id: 'seo_000_mem_swm_nz_LGA',
                name: 'TA (NZ)',
                legendText: module_mem_submodule2_section2_layer2_legendText,
                hover: module_mem_submodule2_sectionall_layers_area_popup_hover,
              },
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'seo_000_mem_dem_cnv_swm_nz_SA2',
                legendText: module_mem_submodule2_section4_layer1_legendText,
                hover: module_mem_submodule2_sectionall_layers_area_popup_hover,
              },
              {
                id: 'seo_000_mem_dem_cnv_swm_nz_LGA',
                name: 'LGA',
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              ...
              {
                name: 'SA1 (NZ)',
                id: 'seo_000_unmtdem_nz_SA1',
                legendText: module_aqu_submodule1_section2_layer1_legendText,
                hover: module_aqu_submodule1_sectionall_layers_area_popup_hover,
              },
              {
                name: 'SA2 (NZ)',
                id: 'seo_000_unmtdem_nz_SA2',
                legendText: module_aqu_submodule1_section2_layer2_legendText,
                hover: module_aqu_submodule1_sectionall_layers_area_popup_hover,
              },
              {
                id: 'seo_000_unmtdem_nz_LGA',
                name: 'TA (NZ)',
                legendText: module_aqu_submodule1_section2_layer3_legendText,
                hover: module_aqu_submodule1_sectionall_layers_area_popup_hover,
              },
