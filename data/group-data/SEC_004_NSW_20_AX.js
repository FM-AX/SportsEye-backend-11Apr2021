...
// 1A. LOGIN SCHREEN
const ACCOUNT_NAME = "VOLLEYBALL NSW"
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/23798b09-4df4-402d-b5ff-5f99ced0a7a7/page/HbFMB" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_mem_dashboard_performance = `
<h1>SPORT PERFORMANCE DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/bb13a34a-1460-44d8-a402-bb72a644ca56/page/hnazB" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_mem_dashboard_wellbeing = `
<h1>HEALTH & WELLBEING DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/10c153ab-6bf0-4cb4-bad2-dbae3dfab9d9/page/iCnzB" frameborder="0" style="border:0" allowfullscreen></iframe>
`
            ...
            layers: [
              {
                ...
                legendText: 'Volleyball NSW Members in SA2 Area',
                // click: TBC,
              ...
              },
              {
                ...
                name: 'LGA',
                legendText: 'Volleyball NSW Members in LGA Area',
                // click: TBC,
                hover: module_mem_sec_004_ax_20_area_popup_hover
              },
              {
                ...
                name: 'REGION',
                legendText: 'Volleyball NSW Members in Govt. Region',
                // click: TBC,
                hover: module_mem_sec_004_ax_20_area_popup_hover
              },
            ]
            ...
            layers: [
              {
                ...
                legendText: 'Volleyball NSW Demand in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_004_ax_20_area_popup_hover
              },
              {
                ...
                name: 'LGA',
                legendText: 'Volleyball NSW Demand in LGA Area',
                // click: TBC,
                hover: module_mem_sec_004_ax_20_area_popup_hover
              },
              {
                ...
                name: 'REGION',
                legendText: 'Volleyball NSW Demand in Govt. Region',
                // click: TBC,
                hover: module_mem_sec_004_ax_20_area_popup_hover
              },
            ]
            ...
            layers: [
              {
                ...
                legendText: 'Volleyball NSW Demand Conversion (%) in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_004_ax_20_area_popup_hover
              },
              {
                ...
                name: 'LGA',
                legendText: 'Volleyball NSW Demand Conversion (%) in LGA Area',
                // click: TBC,
                hover: module_mem_sec_004_ax_20_area_popup_hover
              },
              {
                ...
                name: 'REGION',
                legendText: 'Volleyball NSW Demand Conversion (%) in Govt. Region',
                // click: TBC,
                hover: module_mem_sec_004_ax_20_area_popup_hover
              },
            ]
            ...
            layers: [
              {
                ...
                legendText: 'Volleyball NSW Clubs and Members at Site',
                // click: TBC,
