...
const MAP_START = {
  lat: -36.377216, lng: 145.404284, zoom: 9
}
...
<h4>{AREA_NAME}</h4>
<p>1. Members</p>
<h4>{seo_006_mem_all}</h4>
<p>2. Demand</p>
<h4>{se_leisure_dem}</h4>
<p>3. Conversion</p>
<h4>{seo_006_mem_dem_cnv_all}%</h4>
`
...
<h4>{AREA_NAME}</h4>
<p>1. Members</p>
<h4>{seo_006_mem_swm}</h4>
<p>2. Demand</p>
<h4>{se_swim_dem}</h4>
<p>3. Conversion</p>
<h4>{seo_006_mem_dem_cnv_swm}%</h4>
`
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1D5x3MQ-p9Wimzxo8RUp61vovMM_Xf_WO/page/cAm9" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_healthwellbeing = `
<h1>2. HEALTH AND WELLBEING - YOUR LOCAL GOVT</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1gtb822w8g7qs0DruiL-8c_LrWeBYl35N/page/yNm9" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_socialvalue = `
<h1>3. SOCIAL VALUE SUMMARY</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1B5A_efatDDy8LTTvdWA0xDsRvtZZwuRn/page/28q8" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_siteperformance = `
<h1>4. SITE PERFORMANCE (HEAD OFFICE) DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1CRT3jJavhyrEmzYwGU09vZU2qFlftbKN/page/VqMm" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_groupex = `
<h1>5. PROGRAMS DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1W-5rLZlAy6T5ckB2nozvRHc7Ufq7Dfv4/page/rCRt" frameborder="0" style="border:0" allowfullscreen></iframe>
`
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1vrYSMGiO4dL8mIatEyKTWmazExE34Fh1/page/rCRt" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_covid = `
<h1>8. COVID-19 RECOVERY</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/12AA7HakMEUl4VIZa2J1Fyz4s7-oh-YaG/page/rCRt" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_aqu_dashboard_aquisition = `
<div class="standard-popup">
<h1>ACQUISITION TRACKER</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1mgAG5YMbvEQSlhmV1tZ6n3IRrnyz1nZs/page/gDr8" frameborder="0" style="border:0" allowfullscreen></iframe>
<br><br>
...
<p><a href="https://docs.google.com/spreadsheets/d/1xzS31bP8TGOdGz-HaJJ1cLjCQLJiIN5RgAO6hpYlVH0/edit?usp=sharing" target="_blank" style="text-decoration:underline!important;font-weight:bold;">Click here</a> to view SportsEye Operator Data Standards for your account.</p>
`
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'seo_006_mem_dem_cnv_all_SA2',
                legendText: module_mem_submodule1_section4_layer1_legendText,
                hover: module_mem_submodule1_sectionall_layers_area_popup_hover,
              },
              {
                id: 'seo_006_mem_dem_cnv_all_LGA',
                name: 'LGA',
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'seo_006_mem_dem_cnv_swm_SA2',
                legendText: module_mem_submodule2_section4_layer1_legendText,
                hover: module_mem_submodule2_sectionall_layers_area_popup_hover,
              },
              {
                id: 'seo_006_mem_dem_cnv_swm_LGA',
                name: 'LGA',
