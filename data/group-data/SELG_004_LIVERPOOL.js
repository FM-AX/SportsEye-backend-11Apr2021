...
// 1A. LOGIN SCHREEN
const ACCOUNT_NAME = "LIVERPOOL CITY COUNCIL"
...
const MAP_START = {
   lat: -33.946, lng: 150.953, zoom: 10 //LIVERPOOL
} 
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/e2f12a04-bc9c-4fe1-9cf1-0dc39bdb6f6a/page/1SACB" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_lap_dashboard_aquatic = `
<h1>SWIM SCHOOL</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/fb1c911e-d2d5-4215-81e4-0c4bd3d32617/page/AkzpB" frameborder="0" style="border:0" allowfullscreen></iframe>
`
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/fc43e8b8-e047-48fd-a0f6-4ba7337cd3b6/page/eQUhB" frameborder="0" style="border:0" allowfullscreen></iframe>
`


const module_mem_dashboard_summary = `
<h1>SPORT SUMMARY DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/86e0bfd7-ee6a-477b-861e-80417041990a/page/HbFMB" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_mem_dashboard_performance = `
<h1>SPORT PERFORMANCE DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/f4c86a75-8a66-4216-addb-b36639ab0d72/page/mZ1r" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_mem_dashboard_wellbeing = `
<h1>HEALTH & WELLBEING DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/db82bcca-253a-4112-8f19-3266cbbc2998/page/hzYJB" frameborder="0" style="border:0" allowfullscreen></iframe>
`
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'selg_004_mem_dem_cnv_SA2',
                legendText: 'Total Demand Conversion (%) in SA2 Area',
                // click: module_lap_area_popup_hover,
                hover: module_lap_area_popup_hover,
              },
              {
                id: 'selg_004_mem_dem_cnv_LGA',
                name: 'LGA',
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA1',
                id: 'selg_004_unmtdem_SA1',
                legendText: 'Projected Unmet Demand in SA1 Area',
                hover: '<p>{AREA_NAME}<p><p>Unmet Demand:</p><h4>{selg_004_unmtdem}</h4>',
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA1',
                id: 'selg_004_chngdem_SA1',
                legendText: 'Change in Demand in SA1 Area',
                hover: '<p>{AREA_NAME}<p><p>Change in Demand:</p><h4>{selg_004_chngdem}</h4>',
              },
            ]
          },//END OF SECTION
        ]
