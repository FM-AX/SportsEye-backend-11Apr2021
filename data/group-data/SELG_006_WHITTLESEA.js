...
// 1A. LOGIN SCHREEN
const ACCOUNT_NAME = "CITY OF WHITTLESEA"
...
const MAP_START = {
   lat: -37.564341, lng: 145.065271, zoom: 10 //WHITTLESEA
} 
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/432a7e82-a479-4af7-97e4-5a2e7900d4be/page/Mt8jB" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_lap_dashboard_aquatic = `
<h1>SWIM SCHOOL</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/3e5b74b1-d5fb-43c6-9bfa-3ca3eafad83f/page/AkzpB" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_lap_dashboard_social = `
<h1>SOCIAL VALUE</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1cgAjLE9UZPSIu2-x7JTiO-IyC32qs1c-/page/28q8" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_lap_dashboard_covid = `
<h1>COVID RECOVERY</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/3dfe0043-ca34-4d82-bcdc-bd8b82ea0efa/page/LBokB" frameborder="0" style="border:0" allowfullscreen></iframe>
`
    ...
    CODES: [
      {
        ...
        sections: [
          ...
          {
            heading: '4. CONVERSION (AREA)',
            text: module_lap_cnv_text,
            icon: AREA_ICON,
            layers: [
              {
                name: 'SA2',
                id: 'selg_006_mem_dem_cnv_SA2',
                legendText: 'Total Demand Conversion (%) in SA2 Area',
                // click: module_lap_area_popup_hover,
                hover: module_lap_area_popup_hover,
              },
              {
                id: 'selg_006_mem_dem_cnv_LGA',
                name: 'LGA',
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA1',
                id: 'selg_006_unmtdem_SA1',
                legendText: 'Projected Unmet Demand in SA1 Area',
                hover: '<p>{AREA_NAME}<p><p>Unmet Demand:</p><h4>{selg_006_unmtdem}</h4>',
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA1',
                id: 'selg_006_chngdem_SA1',
                legendText: 'Change in Demand in SA1 Area',
                hover: '<p>{AREA_NAME}<p><p>Change in Demand:</p><h4>{selg_006_chngdem}</h4>',
              },
            ]
          },//END OF SECTION
        ]
