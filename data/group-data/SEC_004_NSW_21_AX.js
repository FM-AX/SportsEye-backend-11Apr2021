...
// 1A. LOGIN SCHREEN
const ACCOUNT_NAME = "TOUCH FOOTBALL NSW"
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/47675cac-73a2-4211-8a28-f4307421346c/page/vvX3B" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_mem_dashboard_performance = `
<h1>SPORT PERFORMANCE DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/b412650b-7eaf-46da-a636-2ddf527567ba/page/axX3B" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_mem_dashboard_wellbeing = `
<h1>HEALTH & WELLBEING DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/5cf0c294-41df-4bf0-846e-cf769704fa21/page/DDH4B" frameborder="0" style="border:0" allowfullscreen></iframe>
`
            ...
            layers: [
              {
                ...
                legendText: 'Touch Football NSW Members in SA2 Area',
                // click: TBC,
              ...
              },
              {
                ...
                name: 'LGA',
                legendText: 'Touch Football NSW Members in LGA Area',
                // click: TBC,
                hover: module_mem_sec_004_ax_21_area_popup_hover
              },
              {
                ...
                name: 'REGION',
                legendText: 'Touch Football NSW Members in Govt. Region',
                // click: TBC,
                hover: module_mem_sec_004_ax_21_area_popup_hover
              },
            ]
            ...
            layers: [
              {
                ...
                legendText: 'Touch Football NSW Demand in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_004_ax_21_area_popup_hover
              },
              {
                ...
                name: 'LGA',
                legendText: 'Touch Football NSW Demand in LGA Area',
                // click: TBC,
                hover: module_mem_sec_004_ax_21_area_popup_hover
              },
              {
                ...
                name: 'REGION',
                legendText: 'Touch Football NSW Demand in Govt. Region',
                // click: TBC,
                hover: module_mem_sec_004_ax_21_area_popup_hover
              },
            ]
            ...
            layers: [
              {
                ...
                legendText: 'Touch Football NSW Demand Conversion (%) in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_004_ax_21_area_popup_hover
              },
              {
                ...
                name: 'LGA',
                legendText: 'Touch Football NSW Demand Conversion (%) in LGA Area',
                // click: TBC,
                hover: module_mem_sec_004_ax_21_area_popup_hover
              },
              {
                ...
                name: 'REGION',
                legendText: 'Touch Football NSW Demand Conversion (%) in Govt. Region',
                // click: TBC,
                hover: module_mem_sec_004_ax_21_area_popup_hover
              },
            ]
            ...
            layers: [
              {
                ...
                legendText: 'Touch Football NSW Clubs and Members at Site',
                // click: TBC,
