...
// 1A. LOGIN SCHREEN
const ACCOUNT_NAME = "SPORT CANTERBURY"
...
// 1. POPUPS
const module_mem_sec_002_comb_mem_area_popup_hover = require('../group-references/SEC_FILES/SEC_002_CANTERBURY/my_members/comb/area_mem_popup_hover')
const module_mem_sec_002_comb_dem_area_popup_hover = require('../group-references/SEC_FILES/SEC_002_CANTERBURY/my_members/comb/area_dem_popup_hover')
const module_mem_sec_002_comb_mem_dem_cnv_area_popup_hover = require('../group-references/SEC_FILES/SEC_002_CANTERBURY/my_members/comb/area_mem_dem_cnv_popup_hover')
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1W2RQjkgMQkXmE4-oTsh0W_QQORlHMHC6/page/b9G6" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_mem_dashboard_performance = `
<h1>SITE & AREA PRIORITIES</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1O4wjvhXKWPA9MDNFdWmkm75LTyJkYxy-/page/cAm9" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_mem_dashboard_wellbeing = `
<h1>HEALTH & WELLBEING DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1pKzGp77Ek37cb1nHSAI1HDqIu9dLVq9X/page/yNm9" frameborder="0" style="border:0" allowfullscreen></iframe>
`


// 3. LAYER TEXT

const module_mem_combined_site_text = require('../group-references/SEC_FILES/SEC_002_CANTERBURY/my_members/module_mem_combined_site_text')
    ...
    CODES: [
      {
        ...
        sections: [
          ...
          {
            heading: '2. SITE & AREA PRIORITIES',
            text: null,
            icon: DASHBOARD_ICON,
        ...
        sections: [
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'sec_002_comb_mem_SA2',
                legendText: 'Combined Sport Members in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_002_comb_mem_area_popup_hover
              },
              {
                id: 'sec_002_comb_mem_LGA',
                name: 'LGA',
                legendText: 'Combined Sport Members in TA Area',
                // click: TBC,
                hover: module_mem_sec_002_comb_mem_area_popup_hover
              },
              {
                id: 'sec_002_comb_mem_REG',
                name: 'REGION',
                legendText: 'Combined Sport Members in RC Area',
                // click: TBC,
                hover: module_mem_sec_002_comb_mem_area_popup_hover
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'sec_002_comb_dem_SA2',
                legendText: 'Combined Sport Demand in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_002_comb_dem_area_popup_hover
              },
              {
                id: 'sec_002_comb_dem_LGA',
                name: 'LGA',
                legendText: 'Combined Sport Demand in TA Area',
                // click: TBC,
                hover: module_mem_sec_002_comb_dem_area_popup_hover
              },
              {
                id: 'sec_002_comb_dem_REG',
                name: 'REGION',
                legendText: 'Combined Sport Demand in RC Area',
                // click: TBC,
                hover: module_mem_sec_002_comb_dem_area_popup_hover
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'sec_002_comb_mem_dem_cnv_SA2',
                legendText: 'Combined Sport Demand Conversion (%) in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_002_comb_mem_dem_cnv_area_popup_hover
              },
              {
                id: 'sec_002_comb_mem_dem_cnv_LGA',
                name: 'LGA',
                legendText: 'Combined Sport Demand Conversion (%) in TA Area',
                // click: TBC,
                hover: module_mem_sec_002_comb_mem_dem_cnv_area_popup_hover
              },
              {
                id: 'sec_002_comb_mem_dem_cnv_REG',
                name: 'REGION',
                legendText: 'Combined Sport Demand Conversion (%) in RC Area',
                // click: TBC,
                hover: module_mem_sec_002_comb_mem_dem_cnv_area_popup_hover
              },
            ]
        ...
        sections: [
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'sec_002_athl_mem_SA2',
                legendText: 'Athletics Members in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_002_athl_area_popup_hover
              },
              {
                id: 'sec_002_athl_mem_LGA',
                name: 'LGA',
                legendText: 'Athletics Members in TA Area',
                // click: TBC,
                hover: module_mem_sec_002_athl_area_popup_hover
              },
              {
                id: 'sec_002_athl_mem_REG',
                name: 'REGION',
                legendText: 'Athletics Members in RC Area',
                // click: TBC,
                hover: module_mem_sec_002_athl_area_popup_hover
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'sec_002_athl_dem_SA2',
                legendText: 'Athletics Demand in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_002_athl_area_popup_hover
              },
              {
                id: 'sec_002_athl_dem_LGA',
                name: 'LGA',
                legendText: 'Athletics Demand in TA Area',
                // click: TBC,
                hover: module_mem_sec_002_athl_area_popup_hover
              },
              {
                id: 'sec_002_athl_dem_REG',
                name: 'REGION',
                legendText: 'Athletics Demand in RC Area',
                // click: TBC,
                hover: module_mem_sec_002_athl_area_popup_hover
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'sec_002_athl_mem_dem_cnv_SA2',
                legendText: 'Athletics Demand Conversion (%) in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_002_athl_area_popup_hover
              },
              {
                id: 'sec_002_athl_mem_dem_cnv_LGA',
                name: 'LGA',
                legendText: 'Athletics Demand Conversion (%) in TA Area',
                // click: TBC,
                hover: module_mem_sec_002_athl_area_popup_hover
              },
              {
                id: 'sec_002_athl_mem_dem_cnv_REG',
                name: 'REGION',
                legendText: 'Athletics Demand Conversion (%) in RC Area',
                // click: TBC,
                hover: module_mem_sec_002_athl_area_popup_hover
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SITE',
                id: 'sec_002_athl_SITE',
                legendText: 'Athletics Club Locations',
                // click: TBC,
                hover: module_mem_site_popup_hover
              },
            ]
          },//END OF SECTION
          {
            ...
            text: null,
            icon: DASHBOARD_ICON,
            documentHtml: module_mem_sec_002_athl_dashboard_priorities,
          },//END OF SECTION
          {
            heading: '6. HEALTH & WELLBEING',
            text: null,
            icon: DASHBOARD_ICON,
            documentHtml: module_mem_sec_002_athl_dashboard_wellbeing,
          },//END OF SECTION
        ]
      },//END OF SUB-MODULE
      {
        ...
        sections: [
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'sec_002_bowl_mem_SA2',
                legendText: 'Bowling Members in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_002_bowl_area_popup_hover
              },
              {
                id: 'sec_002_bowl_mem_LGA',
                name: 'LGA',
                legendText: 'Bowling Members in TA Area',
                // click: TBC,
                hover: module_mem_sec_002_bowl_area_popup_hover
              },
              {
                id: 'sec_002_bowl_mem_REG',
                name: 'REGION',
                legendText: 'Bowling Members in RC Area',
                // click: TBC,
                hover: module_mem_sec_002_bowl_area_popup_hover
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'sec_002_bowl_dem_SA2',
                legendText: 'Bowling Demand in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_002_bowl_area_popup_hover
              },
              {
                id: 'sec_002_bowl_dem_LGA',
                name: 'LGA',
                legendText: 'Bowling Demand in TA Area',
                // click: TBC,
                hover: module_mem_sec_002_bowl_area_popup_hover
              },
              {
                id: 'sec_002_bowl_dem_REG',
                name: 'REGION',
                legendText: 'Bowling Demand in RC Area',
                // click: TBC,
                hover: module_mem_sec_002_bowl_area_popup_hover
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'sec_002_bowl_mem_dem_cnv_SA2',
                legendText: 'Bowling Demand Conversion (%) in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_002_bowl_area_popup_hover
              },
              {
                id: 'sec_002_bowl_mem_dem_cnv_LGA',
                name: 'LGA',
                legendText: 'Bowling Demand Conversion (%) in TA Area',
                // click: TBC,
                hover: module_mem_sec_002_bowl_area_popup_hover
              },
              {
                id: 'sec_002_bowl_mem_dem_cnv_REG',
                name: 'REGION',
                legendText: 'Bowling Demand Conversion (%) in RC Area',
                // click: TBC,
                hover: module_mem_sec_002_bowl_area_popup_hover
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SITE',
                id: 'sec_002_bowl_SITE',
                legendText: 'Bowling Club Locations',
                // click: TBC,
                hover: module_mem_site_popup_hover
              },
            ]
          },//END OF SECTION
          {
            ...
            text: null,
            icon: DASHBOARD_ICON,
            documentHtml: module_mem_sec_002_bowl_dashboard_priorities,
          },//END OF SECTION
          {
            heading: '6. HEALTH & WELLBEING',
            text: null,
            icon: DASHBOARD_ICON,
            documentHtml: module_mem_sec_002_bowl_dashboard_wellbeing,
          },//END OF SECTION
        ]
      },//END OF SUB-MODULE    
      {
        ...
        sections: [
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'sec_002_foot_mem_SA2',
                legendText: 'Football Members in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_002_foot_area_popup_hover
              },
              {
                id: 'sec_002_foot_mem_LGA',
                name: 'LGA',
                legendText: 'Football Members in TA Area',
                // click: TBC,
                hover: module_mem_sec_002_foot_area_popup_hover
              },
              {
                id: 'sec_002_foot_mem_REG',
                name: 'REGION',
                legendText: 'Football Members in RC Area',
                // click: TBC,
                hover: module_mem_sec_002_foot_area_popup_hover
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'sec_002_foot_dem_SA2',
                legendText: 'Football Demand in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_002_foot_area_popup_hover
              },
              {
                id: 'sec_002_foot_dem_LGA',
                name: 'LGA',
                legendText: 'Football Demand in TA Area',
                // click: TBC,
                hover: module_mem_sec_002_foot_area_popup_hover
              },
              {
                id: 'sec_002_foot_dem_REG',
                name: 'REGION',
                legendText: 'Football Demand in RC Area',
                // click: TBC,
                hover: module_mem_sec_002_foot_area_popup_hover
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'sec_002_foot_mem_dem_cnv_SA2',
                legendText: 'Football Demand Conversion (%) in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_002_foot_area_popup_hover
              },
              {
                id: 'sec_002_foot_mem_dem_cnv_LGA',
                name: 'LGA',
                legendText: 'Football Demand Conversion (%) in TA Area',
                // click: TBC,
                hover: module_mem_sec_002_foot_area_popup_hover
              },
              {
                id: 'sec_002_foot_mem_dem_cnv_REG',
                name: 'REGION',
                legendText: 'Football Demand Conversion (%) in RC Area',
                // click: TBC,
                hover: module_mem_sec_002_foot_area_popup_hover
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SITE',
                id: 'sec_002_foot_SITE',
                legendText: 'Football Club Locations',
                // click: TBC,
                hover: module_mem_site_popup_hover
              },
            ]
          },//END OF SECTION
          {
            ...
            text: null,
            icon: DASHBOARD_ICON,
            documentHtml: module_mem_sec_002_foot_dashboard_priorities,
          },//END OF SECTION
          {
            heading: '6. HEALTH & WELLBEING',
            text: null,
            icon: DASHBOARD_ICON,
            documentHtml: module_mem_sec_002_foot_dashboard_wellbeing,
          },//END OF SECTION
        ]
      },//END OF SUB-MODULE
      {
        ...
        sections: [
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'sec_002_rugb_mem_SA2',
                legendText: 'Rugby Members in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_002_rugb_area_popup_hover
              },
              {
                id: 'sec_002_rugb_mem_LGA',
                name: 'LGA',
                legendText: 'Rugby Members in TA Area',
                // click: TBC,
                hover: module_mem_sec_002_rugb_area_popup_hover
              },
              {
                id: 'sec_002_rugb_mem_REG',
                name: 'REGION',
                legendText: 'Rugby Members in RC Area',
                // click: TBC,
                hover: module_mem_sec_002_rugb_area_popup_hover
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'sec_002_rugb_dem_SA2',
                legendText: 'Rugby Demand in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_002_rugb_area_popup_hover
              },
              {
                id: 'sec_002_rugb_dem_LGA',
                name: 'LGA',
                legendText: 'Rugby Demand in TA Area',
                // click: TBC,
                hover: module_mem_sec_002_rugb_area_popup_hover
              },
              {
                id: 'sec_002_rugb_dem_REG',
                name: 'REGION',
                legendText: 'Rugby Demand in RC Area',
                // click: TBC,
                hover: module_mem_sec_002_rugb_area_popup_hover
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'sec_002_rugb_mem_dem_cnv_SA2',
                legendText: 'Rugby Demand Conversion (%) in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_002_rugb_area_popup_hover
              },
              {
                id: 'sec_002_rugb_mem_dem_cnv_LGA',
                name: 'LGA',
                legendText: 'Rugby Demand Conversion (%) in TA Area',
                // click: TBC,
                hover: module_mem_sec_002_rugb_area_popup_hover
              },
              {
                id: 'sec_002_rugb_mem_dem_cnv_REG',
                name: 'REGION',
                legendText: 'Rugby Demand Conversion (%) in RC Area',
                // click: TBC,
                hover: module_mem_sec_002_rugb_area_popup_hover
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SITE',
                id: 'sec_002_rugb_SITE',
                legendText: 'Rugby Club Locations',
                // click: TBC,
                hover: module_mem_site_popup_hover
              },
            ]
          },//END OF SECTION
          {
            ...
            text: null,
            icon: DASHBOARD_ICON,
            documentHtml: module_mem_sec_002_rugb_dashboard_priorities,
          },//END OF SECTION
          {
            heading: '6. HEALTH & WELLBEING',
            text: null,
            icon: DASHBOARD_ICON,
            documentHtml: module_mem_sec_002_rugb_dashboard_wellbeing,
          },//END OF SECTION
        ]
      },//END OF SUB-MODULE
      {
        ...
        sections: [
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'sec_002_touc_mem_SA2',
                legendText: 'Touch Rugby Members in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_002_touc_area_popup_hover
              },
              {
                id: 'sec_002_touc_mem_LGA',
                name: 'LGA',
                legendText: 'Touch Rugby Members in TA Area',
                // click: TBC,
                hover: module_mem_sec_002_touc_area_popup_hover
              },
              {
                id: 'sec_002_touc_mem_REG',
                name: 'REGION',
                legendText: 'Touch Rugby Members in RC Area',
                // click: TBC,
                hover: module_mem_sec_002_touc_area_popup_hover
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'sec_002_touc_dem_SA2',
                legendText: 'Touch Rugby Demand in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_002_touc_area_popup_hover
              },
              {
                id: 'sec_002_touc_dem_LGA',
                name: 'LGA',
                legendText: 'Touch Rugby Demand in TA Area',
                // click: TBC,
                hover: module_mem_sec_002_touc_area_popup_hover
              },
              {
                id: 'sec_002_touc_dem_REG',
                name: 'REGION',
                legendText: 'Touch Rugby Demand in RC Area',
                // click: TBC,
                hover: module_mem_sec_002_touc_area_popup_hover
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'sec_002_touc_mem_dem_cnv_SA2',
                legendText: 'Touch Rugby Demand Conversion (%) in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_002_touc_area_popup_hover
              },
              {
                id: 'sec_002_touc_mem_dem_cnv_LGA',
                name: 'LGA',
                legendText: 'Touch Rugby Demand Conversion (%) in TA Area',
                // click: TBC,
                hover: module_mem_sec_002_touc_area_popup_hover
              },
              {
                id: 'sec_002_touc_mem_dem_cnv_REG',
                name: 'REGION',
                legendText: 'Touch Rugby Demand Conversion (%) in RC Area',
                // click: TBC,
                hover: module_mem_sec_002_touc_area_popup_hover
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SITE',
                id: 'sec_002_touc_SITE',
                legendText: 'Touch Rugby Club Locations',
                // click: TBC,
                hover: module_mem_site_popup_hover
              },
            ]
          },//END OF SECTION
          {
            ...
            text: null,
            icon: DASHBOARD_ICON,
            documentHtml: module_mem_sec_002_touc_dashboard_priorities,
          },//END OF SECTION
          {
            heading: '6. HEALTH & WELLBEING',
            text: null,
            icon: DASHBOARD_ICON,
            documentHtml: module_mem_sec_002_touc_dashboard_wellbeing,
          },//END OF SECTION
        ]
      },//END OF SUB-MODULE
      {
        ...
        sections: [
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'sec_002_squa_mem_SA2',
                legendText: 'Squash Members in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_002_squa_area_popup_hover
              },
              {
                id: 'sec_002_squa_mem_LGA',
                name: 'LGA',
                legendText: 'Squash Members in TA Area',
                // click: TBC,
                hover: module_mem_sec_002_squa_area_popup_hover
              },
              {
                id: 'sec_002_squa_mem_REG',
                name: 'REGION',
                legendText: 'Squash Members in RC Area',
                // click: TBC,
                hover: module_mem_sec_002_squa_area_popup_hover
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'sec_002_squa_dem_SA2',
                legendText: 'Squash Demand in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_002_squa_area_popup_hover
              },
              {
                id: 'sec_002_squa_dem_LGA',
                name: 'LGA',
                legendText: 'Squash Demand in TA Area',
                // click: TBC,
                hover: module_mem_sec_002_squa_area_popup_hover
              },
              {
                id: 'sec_002_squa_dem_REG',
                name: 'REGION',
                legendText: 'Squash Demand in RC Area',
                // click: TBC,
                hover: module_mem_sec_002_squa_area_popup_hover
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'sec_002_squa_mem_dem_cnv_SA2',
                legendText: 'Squash Demand Conversion (%) in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_002_squa_area_popup_hover
              },
              {
                id: 'sec_002_squa_mem_dem_cnv_LGA',
                name: 'LGA',
                legendText: 'Squash Demand Conversion (%) in TA Area',
                // click: TBC,
                hover: module_mem_sec_002_squa_area_popup_hover
              },
              {
                id: 'sec_002_squa_mem_dem_cnv_REG',
                name: 'REGION',
                legendText: 'Squash Demand Conversion (%) in RC Area',
                // click: TBC,
                hover: module_mem_sec_002_squa_area_popup_hover
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SITE',
                id: 'sec_002_squa_SITE',
                legendText: 'Squash Club Locations',
                // click: TBC,
                hover: module_mem_site_popup_hover
              },
            ]
          },//END OF SECTION
          {
            ...
            text: null,
            icon: DASHBOARD_ICON,
            documentHtml: module_mem_sec_002_squa_dashboard_priorities,
          },//END OF SECTION
          {
            heading: '6. HEALTH & WELLBEING',
            text: null,
            icon: DASHBOARD_ICON,
            documentHtml: module_mem_sec_002_squa_dashboard_wellbeing,
          },//END OF SECTION
        ]
      },//END OF SUB-MODULE
    ]
