...
<h4>{AREA_NAME}</h4>
<p>1. Members</p>
<h4>{seo_001_mem_all}</h4>
<p>2. Demand</p>
<h4>{se_leisure_dem}</h4>
<p>3. Conversion</p>
<h4>{seo_001_mem_dem_cnv_all}%</h4>
`
...
<h4>{AREA_NAME}</h4>
<p>1. Members</p>
<h4>{seo_001_mem_swm}</h4>
<p>2. Demand</p>
<h4>{se_swim_dem}</h4>
<p>3. Conversion</p>
<h4>{seo_001_mem_dem_cnv_swm}%</h4>
`
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1puCMGx27qRqw3ED5SgqkYuIb7_oQ5CDI/page/cAm9" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_healthwellbeing = `
<h1>2. HEALTH AND WELLBEING - YOUR LOCAL GOVT</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1EwSeCYgOP7dRrcdatUSOEpGk47eGzk1C/page/yNm9" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_socialvalue = `
<h1>3. SOCIAL VALUE SUMMARY</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1JKkTmdsOvw-UR2U2nGLnAQK2od7DKh-i/page/lssn" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_siteperformance = `
<h1>4. SITE PERFORMANCE (HEAD OFFICE) DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1mkjAZnVtaWd-m_BNH_1kNSSiYRJMy7c8/page/VqMm" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_groupex = `
<h1>5. PROGRAMS DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1wlo0gqcg0AScNFLKwlHBs7Fttu09kkD2/page/0RTw" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_swimschool = `
<h1>6. SWIM SCHOOL DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/dd243b89-2dd2-46eb-b417-91fdb6cfdd09/page/1M" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_pricing = `
<h1>7. PRICING DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1JVqqaB2Rq3PC-wVTBuJrybJAmIiI__xM/page/rCRt" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_covid = `
<h1>8. COVID-19 RECOVERY</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1alcut5KFE1pazSALI5cjro3RP4fVT39I/page/rCRt" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_aqu_dashboard_aquisition = `
<div class="standard-popup">
<h1>ACQUISITION TRACKER</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1ShM0q_As4lrctPlBme1Jbim40Ww-8Bge/page/gDr8" frameborder="0" style="border:0" allowfullscreen></iframe>
<br><br>
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/148gx_XpPJkRDRkOf2FMc0iRPM_BzzYV1/page/VqMm" frameborder="0" style="border:0" allowfullscreen></iframe>
<br><br>
<a class="contact-button" href="https://docs.google.com/spreadsheets/d/1FiQrNo-pFx1bBKww62SfwLlcZt9DolhSRZ7LzNLYMQg/edit#gid=1088877429" target=_blank ><span class="h2">AT RISK MEMBERS</span><span class="download-icon"></span><span class="p">Click here to access Retention download.</span></a></div><!-- END OF POPUP -->
...
<p><a href="https://docs.google.com/spreadsheets/d/1QoS0ttVMRXl624gWcWcjsMNZLhpwfH-XLfZw7Yxi6A0/edit?usp=sharing" target="_blank" style="text-decoration:underline!important;font-weight:bold;">Click here</a> to view SportsEye Operator Data Standards for your account.</p>
`
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'seo_001_mem_dem_cnv_all_SA2',
                legendText: module_mem_submodule1_section4_layer1_legendText,
                hover: module_mem_submodule1_sectionall_layers_area_popup_hover,
              },
              {
                id: 'seo_001_mem_dem_cnv_all_LGA',
                name: 'LGA',
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'seo_001_mem_dem_cnv_swm_SA2',
                legendText: module_mem_submodule2_section4_layer1_legendText,
                hover: module_mem_submodule2_sectionall_layers_area_popup_hover,
              },
              {
                id: 'seo_001_mem_dem_cnv_swm_LGA',
                name: 'LGA',
