...
// 1A. LOGIN SCHREEN
const ACCOUNT_NAME = "CITY OF CANNING"
...
const MAP_START = {
  lat: -32.024289, lng: 115.929591, zoom: 10 //CANNING
}
...
<h4>{AREA_NAME}</h4>
<p>1. Members</p>
<h4>{seo_013_mem_all}</h4>
<p>2. Demand</p>
<h4>{se_leisure_dem}</h4>
<p>3. Conversion</p>
<h4>{seo_013_mem_dem_cnv_all}%</h4>
`
...
<h4>{AREA_NAME}</h4>
<p>1. Members</p>
<h4>{seo_013_mem_swm}</h4>
<p>2. Demand</p>
<h4>{se_swim_dem}</h4>
<p>3. Conversion</p>
<h4>{seo_013_mem_dem_cnv_swm}%</h4>
`
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1DCzVBf8eGOTODRP8NeFcjPMK1zyIaslK/page/cAm9" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_healthwellbeing = `
<h1>2. HEALTH AND WELLBEING - YOUR LOCAL GOVT</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1j2rvXvPGcBF-KCBTF_QDimc_lFtenGNd/page/yNm9" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_socialvalue = `
<h1>3. SOCIAL VALUE SUMMARY</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1Kr_rw4Ts6bdnJWoaN9b1NdhyHRgpRbGK/page/28q8" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_siteperformance = `
<h1>4. SITE PERFORMANCE (HEAD OFFICE) DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1juUIlVJiSa9uhjQuiPk8-R-HpQAPXd8X/page/VqMm" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_groupex = `
<h1>5. PROGRAMS DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1AZtX62NRtNx9LqjWl5HHGO0cOYx71Il_/page/rCRt" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_swimschool = `
<h1>6. SWIM SCHOOL DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/54b39a76-55af-4dfe-bc35-4dc34b706912/page/1M" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_pricing = `
<h1>7. PRICING DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1ob59tivXxS0o8-c9vMrCTQl77kfhNWAO/page/rCRt" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_covid = `
<h1>8. COVID-19 RECOVERY</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/19npb4eiA8WUjzHFqO_rAXCOEvDOlxqJm/page/rCRt" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_aqu_dashboard_aquisition = `
<div class="standard-popup">
<h1>ACQUISITION TRACKER</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1U4Gd_6ZA_g-vE2FhvT3uUM0jqWN4VmJv/page/q1vq" frameborder="0" style="border:0" allowfullscreen></iframe>
<br><br>
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/0955ed6e-c4a3-49c3-a9c1-64e264bbc303/page/6pWGB" frameborder="0" style="border:0" allowfullscreen></iframe>
<br><br>
<a class="contact-button" href="https://docs.google.com/spreadsheets/d/1BX6peuVA44EXP7td6yRARUk6ELvq3XAzmtENQAltV5M/edit#gid=1088877429" target=_blank ><span class="h2">AT RISK MEMBERS</span><span class="download-icon"></span><span class="p">Click here to access Retention download.</span></a></div><!-- END OF POPUP -->
...
<p><a href="https://docs.google.com/spreadsheets/d/1tXx64I_ACoNYQ9WjJf8lP1RcX0g4QLpuSZqssY4tfFo/edit?usp=sharing" target="_blank" style="text-decoration:underline!important;font-weight:bold;">Click here</a> to view SportsEye Operator Data Standards for your account.</p>
`
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'seo_013_mem_dem_cnv_all_SA2',
                legendText: module_mem_submodule1_section4_layer1_legendText,
                hover: module_mem_submodule1_sectionall_layers_area_popup_hover,
              },
              {
                id: 'seo_013_mem_dem_cnv_all_LGA',
                name: 'LGA',
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'seo_013_mem_dem_cnv_swm_SA2',
                legendText: module_mem_submodule2_section4_layer1_legendText,
                hover: module_mem_submodule2_sectionall_layers_area_popup_hover,
              },
              {
                id: 'seo_013_mem_dem_cnv_swm_LGA',
                name: 'LGA',
