...
// 1A. LOGIN SCHREEN
const ACCOUNT_NAME = "LAKE MACQUARIE"
...
const MAP_START = {
  ...
  lat: -33.0697359, lng: 151.4414326, zoom: 10 //Lake MQ SYDNEY
} 
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1aDPzXCobqhlrbEFO9rC37yYdgUkeTqs2/page/P9JpB" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_lap_dashboard_aquatic = `
<h1>SWIM SCHOOL</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/323995ec-e901-42aa-a12e-1ba65bb834e7/page/8iFsB" frameborder="0" style="border:0" allowfullscreen></iframe>
`
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1IZY0TrtuafXtUC6ZSrmTImU18An0GZBX/page/yqYkB" frameborder="0" style="border:0" allowfullscreen></iframe>
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/a6722a07-49fb-4ae5-bc29-b41b99d5e9d8/page/03CvB" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_mem_dashboard_performance = `
<h1>SPORT PERFORMANCE DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/84730238-a1fb-464c-af82-d208c506a608/page/REDvB" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_mem_dashboard_wellbeing = `
<h1>HEALTH & WELLBEING DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/9f376a52-f6b2-460a-9c91-fb91087a51f8/page/5cEvB" frameborder="0" style="border:0" allowfullscreen></iframe>
`
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'selg_025_mem_dem_cnv_SA2',
                legendText: 'Total Demand Conversion (%) in SA2 Area',
                // click: module_lap_area_popup_hover,
                hover: module_lap_area_popup_hover,
              },
              {
                id: 'selg_025_mem_dem_cnv_LGA',
                name: 'LGA',
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA1',
                id: 'selg_025_unmtdem_SA1',
                legendText: 'Projected Unmet Demand in SA1 Area',
                hover: '<p>{AREA_NAME}<p><p>Unmet Demand:</p><h4>{selg_025_unmtdem}</h4>',
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA1',
                id: 'selg_025_chngdem_SA1',
                legendText: 'Change in Demand in SA1 Area',
                hover: '<p>{AREA_NAME}<p><p>Change in Demand:</p><h4>{selg_025_chngdem}</h4>',
              },
            ]
          },//END OF SECTION
        ]
