...
// 1A. LOGIN SCHREEN
const ACCOUNT_NAME = "RUGBY LEAGUE NSW"
...
// SEP-006-v1.2-LEAGUE
const MAPBOX_STYLE = "mapbox://styles/activexchange-prod/ckcef5z6z0j891is09zw3ko5r" 
...
// 1. POPUPS
const CLICK_ENGAGEMENT_AREA_PARTICIPATION = require('../group-references/SEP_006_LEAGUENSW/CLICK_ENGAGEMENT_AREA_PARTICIPATION')
const CLICK_ENGAGEMENT_AREA_OTHER = require('../group-references/SEP_006_LEAGUENSW/CLICK_ENGAGEMENT_AREA_OTHER')
const CLICK_RESOURCES_PROVISION = require('../group-references/SEP_TEMPLATES/CLICK_RESOURCES_PROVISION')
const CLICK_RESOURCES_SITE = require('../group-references/SEP_006_LEAGUENSW/CLICK_RESOURCES_SITE')
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/f37bd941-f30a-484b-8a8e-fcc73fd192dd/page/HbFMB" frameborder="0" style="border:0" allowfullscreen></iframe>
`
...
<p>All Rugby League NSW Sites</p>
`
...
Difference between 2019 Participants and 2017 Participants
`
...
const STATE_SUMMARY = require('../group-references/SEP_006_LEAGUENSW/STATE_SUMMARY')
const DATA_SCORECARD = require('../group-references/SEP_TEMPLATES/DATA_SCORECARD')

const REPORT_STRATEGIC_CONTEXT_INTRODUCTION = require('../group-references/SEP_003_FOOTBALLNSW/REPORT_STRATEGIC_CONTEXT_INTRODUCTION')
const REPORT_STRATEGIC_CONTEXT_INDUSTRY = require('../group-references/SEP_003_FOOTBALLNSW/REPORT_STRATEGIC_CONTEXT_INDUSTRY')
const REPORT_STRATEGIC_CONTEXT_GOVT = require('../group-references/SEP_003_FOOTBALLNSW/REPORT_STRATEGIC_CONTEXT_GOVT')
const REPORT_STRATEGIC_CONTEXT_SPRT = require('../group-references/SEP_003_FOOTBALLNSW/REPORT_STRATEGIC_CONTEXT_SPRT')
const REPORT_STRATEGIC_CONTEXT_STAKEHOLDER = require('../group-references/SEP_003_FOOTBALLNSW/REPORT_STRATEGIC_CONTEXT_STAKEHOLDER')
const REPORT_STRATEGIC_VISION_PRIORITIES = require('../group-references/SEP_003_FOOTBALLNSW/REPORT_STRATEGIC_VISION_PRIORITIES')
const REPORT_STRATEGIC_VISION_FRAMEWORK = require('../group-references/SEP_003_FOOTBALLNSW/REPORT_STRATEGIC_VISION_FRAMEWORK')
const REPORT_STRATEGIC_VISION_TARGETS = require('../group-references/SEP_003_FOOTBALLNSW/REPORT_STRATEGIC_VISION_TARGETS')
...
const CATEGORIES = [
  {
    ...
    CODES: [
      {
        name: 'STATE OF RUGBY LEAGUE IN NSW',
        id: '1A_SUMMARY',
            ...
            layers: [
              {
                name: 'SITE',
                id: 'SITE_OVERVIEW',
                legendText: 'Rugby League NSW Sites',
            ...
            layers: [
              {
                ...
                hover: '<h4>{SITE_NAME}</h4><p>Participants:</p><h4>{SITE_MEM_ALL}</h4><p>Clubs:</p<!--Participants:</p><!-- <h4>{SITE_CLUBS_PRT}</h4> --><h4>{SITE_CLUBS}</h4>',
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                ...
                name: 'GOV REGION',
                legendText: 'Total Capacity of Playing Fields in Govt. Region',
              ...
              },
              {
                ...
                name: 'LGA',
                legendText: 'Total Capacity of Playing Fields in LGA Area',
                hover: '<h4>{AREA_NAME}</h4><p>Capacity:</p><h4>{AREA_FACL_ASSET_COUNT}</h4><p>Facilities:<p><h4>{AREA_FACL_COUNT}</h4>',
              },
            ]
          },//END OF SECTION
            ...
            layers: [
              {
                ...
                name: 'GOV REGION',
                legendText: 'Ratio of Members to Capacity of Playing Fields in Govt. Region',
              ...
              },
              {
                ...
                name: 'LGA',
                legendText: 'Ratio of Members to Capacity of Playing Fields in LGA Area',
                hover: '<h4>{AREA_NAME}</h4><p>Ratio:</p><h4>{AREA_PROV_MEM}</h4><i>Click to view full area details</i>',
                click: CLICK_RESOURCES_PROVISION,
              },
            ]
            ...
            layers: [
              {
                ...
                name: 'GOV REGION',
                legendText: 'Ratio of Demand to Capacity of Playing Fields in Govt. Region',
              ...
              },
              {
                ...
                name: 'LGA',
                legendText: 'Ratio of Demand to Capacity of Playing Fields in LGA Area',
                hover: '<h4>{AREA_NAME}</h4><p>Ratio:</p><h4>{AREA_PROV_DEM}</h4><i>Click to view full area details</i>',
                click: CLICK_RESOURCES_PROVISION,
              },
            ]
            ...
            layers: [
              {
                ...
                name: 'GOV REGION',
                legendText: 'Ratio of Population to Capacity of Playing Fields in Govt. Region',
              ...
              },
              {
                ...
                name: 'LGA',
                legendText: 'Ratio of Population to Capacity of Playing Fields in LGA Area',
                hover: '<h4>{AREA_NAME}</h4><p>Ratio:</p><h4>{AREA_PROV_POP}</h4><i>Click to view full area details</i>',
                click: CLICK_RESOURCES_PROVISION,
              },
            ]
        ...
        sections: [
          {
            ...
            layers: [
              {
                id: 'GAP_TYPEA_26_CUST',
                name: 'FB REGION',
                legendText: '2026 Competition Gap in Football Region',
              },
              {
                id: 'GAP_TYPEA_26_REG',
                name: 'GOV REGION',
