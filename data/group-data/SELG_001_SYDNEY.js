...
// 1A. LOGIN SCHREEN
const ACCOUNT_NAME = "CITY OF SYDNEY"
...
const MAP_START = {
   lat: -33.8688, lng: 151.2093, zoom: 12 //SYDNEY
} 
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1mbDvPFgv_m5QagrQMCPArLaUmyeYN_iH/page/cAm9" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_lap_dashboard_aquatic = `
<h1>SWIM SCHOOL</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/e22cc5bb-8f46-4303-85f9-16c3aee606bb/page/g4ANB" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_lap_dashboard_social = `
<h1>SOCIAL VALUE</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1yqCn0LTu9zfLQplBGARFH3qltqW3laGK/page/hfZ8" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_lap_dashboard_covid = `
<h1>COVID RECOVERY</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/120fcc86-7fa0-4d30-a4ae-dfb7e3cd9f1b/page/eQUhB" frameborder="0" style="border:0" allowfullscreen></iframe>
`


const module_mem_dashboard_summary = `
<h1>SPORT SUMMARY DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1M9iQFoAqa89rgIhoSrXB7xK1WsvKEfzZ/page/HbFMB" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_mem_dashboard_performance = `
<h1>SPORT PERFORMANCE DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1OoB1sW_lrinLfdnM7okhejbXf9CjLsCS/page/mZ1r" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_mem_dashboard_wellbeing = `
<h1>HEALTH & WELLBEING DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1WZ6zMvdde1pOsI7fMunAzIsDns2_O40h/page/hzYJB" frameborder="0" style="border:0" allowfullscreen></iframe>
`
    ...
    CODES: [
      {
        ...
        sections: [
          {
            heading: 'CITY OF SYDNEY BOUNDARIES',
            ...
            layers: [
              {
                ...
                hover: '<p>Area Name:<p><h4>{AREA_NAME}</h4>',
              },
              {
                name: 'BOUNDARY',
                id: 'selg_001_BNDRY',
                legendText: 'LGA Boundary',
                // click: AREA_COMMUNITY_POPUP,
                hover: '<p>Area Name:<p><h4>{AREA_NAME}</h4>',
              },
            ]
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'selg_001_mem_dem_cnv_SA2',
                legendText: 'Total Demand Conversion (%) in SA2 Area',
                // click: module_lap_area_popup_hover,
                hover: module_lap_area_popup_hover,
              },
              {
                id: 'selg_001_mem_dem_cnv_LGA',
                name: 'LGA',
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA1',
                id: 'selg_001_unmtdem_SA1',
                legendText: 'Projected Unmet Demand in SA1 Area',
                hover: '<p>{AREA_NAME}<p><p>Unmet Demand:</p><h4>{selg_001_unmtdem}</h4>',
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA1',
                id: 'selg_001_chngdem_SA1',
                legendText: 'Change in Demand in SA1 Area',
                hover: '<p>{AREA_NAME}<p><p>Change in Demand:</p><h4>{selg_001_chngdem}</h4>',
              },
            ]
          },//END OF SECTION
        ]
