...
const MAP_START = {
  lat: -34.073239, lng: 150.807914, zoom: 9 //SYDNEY
}
...
<h4>{AREA_NAME}</h4>
<p>1. Members</p>
<h4>{seo_012_mem_all}</h4>
<p>2. Demand</p>
<h4>{se_leisure_dem}</h4>
<p>3. Conversion</p>
<h4>{seo_012_mem_dem_cnv_all}%</h4>
`
...
<h4>{AREA_NAME}</h4>
<p>1. Members</p>
<h4>{seo_012_mem_swm}</h4>
<p>2. Demand</p>
<h4>{se_swim_dem}</h4>
<p>3. Conversion</p>
<h4>{seo_012_mem_dem_cnv_swm}%</h4>
`
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1vzIZj8HA9MOvzTVR7Y5zamC5SuQQkqv5/page/cAm9" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_healthwellbeing = `
<h1>2. HEALTH AND WELLBEING - YOUR LOCAL GOVT</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1HroDwNyPCeq8lSEfOTgBbZGoBAXH89qB/page/yNm9" frameborder="0" style="border:0" allowfullscreen></iframe>
`
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1oS_usBuJRXfqQKZisvM21sRc92WVFJxL/page/VqMm" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_groupex = `
<h1>5. PROGRAMS DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1zbFssYLjOWL-34dcqiZ9R98dZ9TQiZBE/page/HpO9" frameborder="0" style="border:0" allowfullscreen></iframe>
`
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1AsQLU6M-V04WhxqDzS4quQJNzJWhunBa/page/rCRt" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_covid = `
<h1>7. COVID-19 RECOVERY</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1_d0JXbNqb5h9YfAzuQiTKLmYiwDUE5gb/page/rCRt" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_aqu_dashboard_aquisition = `
<div class="standard-popup">
<h1>ACQUISITION TRACKER</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1xxcBXFM02hvBUT-yxSoytRtey13UO1Iv/page/gDr8" frameborder="0" style="border:0" allowfullscreen></iframe>
<br><br>
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/315f0a49-4163-4e59-b874-3ca0d3d862d5/page/6pWGB" frameborder="0" style="border:0" allowfullscreen></iframe>
<br><br>
<a class="contact-button" href="https://docs.google.com/spreadsheets/d/1nklKur7Pftc-xRqqFFEWJQ_mgeI-Z8-NDSVEvdMNQ6w/edit#gid=14626861" target=_blank ><span class="h2">AT RISK MEMBERS</span><span class="download-icon"></span><span class="p">Click here to access Retention download.</span></a></div><!-- END OF POPUP -->
...
<p><a href="https://docs.google.com/spreadsheets/d/10AWxtfRs1-CxDEc9EuqHQ6VDzdmByLcqXDalRtTzy7Y/edit#gid=675536604" target="_blank" style="text-decoration:underline!important;font-weight:bold;">Click here</a> to view SportsEye Operator Data Standards for your account.</p>
`
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'seo_012_mem_dem_cnv_all_SA2',
                legendText: module_mem_submodule1_section4_layer1_legendText,
                hover: module_mem_submodule1_sectionall_layers_area_popup_hover,
              },
              {
                id: 'seo_012_mem_dem_cnv_all_LGA',
                name: 'LGA',
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'seo_012_mem_dem_cnv_swm_SA2',
                legendText: module_mem_submodule2_section4_layer1_legendText,
                hover: module_mem_submodule2_sectionall_layers_area_popup_hover,
              },
              {
                id: 'seo_012_mem_dem_cnv_swm_LGA',
                name: 'LGA',
