...
const MAP_START = {
   lat: -37.679, lng: 176.250, zoom: 9 //TAURANGA
}
...
<h4>{AREA_NAME}</h4>
<p>1. Members</p>
<h4>{seo_005_mem_all}</h4>
<p>2. Demand</p>
<h4>{se_leisure_dem}</h4>
<p>3. Conversion</p>
<h4>{seo_005_mem_dem_cnv_all}%</h4>
`
...
<h4>{AREA_NAME}</h4>
<p>1. Members</p>
<h4>{seo_005_mem_swm}</h4>
<p>2. Demand</p>
<h4>{se_swim_dem}</h4>
<p>3. Conversion</p>
<h4>{seo_005_mem_dem_cnv_swm}%</h4>
`
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1fr7sHml8dw3xxO6vNET4DRArN3DqtGcb/page/VqMm" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_groupex = `
<h1>5. PROGRAMS DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/15kYa8eCsjNUdpDuhemXgg5VfhiXk7bUI/page/rCRt" frameborder="0" style="border:0" allowfullscreen></iframe>
`
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/12q7KlfRafzsC5bCEMK8JROqLvxhlP4rG/page/rCRt" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_covid = `
<h1>8. COVID-19 RECOVERY</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1X1vnvINqg6Kbf2VkertWzYa1c2clv3vt/page/rCRt" frameborder="0" style="border:0" allowfullscreen></iframe>
`
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'seo_005_mem_dem_cnv_all_SA2',
                legendText: module_mem_submodule1_section4_layer1_legendText,
                hover: module_mem_submodule1_sectionall_layers_area_popup_hover,
              },
              {
                id: 'seo_005_mem_dem_cnv_all_LGA',
                name: 'LGA',
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'seo_005_mem_dem_cnv_swm_SA2',
                legendText: module_mem_submodule2_section4_layer1_legendText,
                hover: module_mem_submodule2_sectionall_layers_area_popup_hover,
              },
              {
                id: 'seo_005_mem_dem_cnv_swm_LGA',
                name: 'LGA',
