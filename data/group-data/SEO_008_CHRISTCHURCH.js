...
// 1A. LOGIN SCHREEN
const ACCOUNT_NAME = "CHRISTCHURCH"
...
<h4>{AREA_NAME}</h4>
<p>1. Members</p>
<h4>{seo_008_mem_all}</h4>
<p>2. Demand</p>
<h4>{se_leisure_dem}</h4>
<p>3. Conversion</p>
<h4>{seo_008_mem_dem_cnv_all}%</h4>
`
...
<h4>{AREA_NAME}</h4>
<p>1. Members</p>
<h4>{seo_008_mem_swm}</h4>
<p>2. Demand</p>
<h4>{se_swim_dem}</h4>
<p>3. Conversion</p>
<h4>{seo_008_mem_dem_cnv_swm}%</h4>
`
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1rfuHt7qn6laC-NaX7WabGgUA3UtkFzT1/page/cAm9" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_healthwellbeing = `
<h1>2. HEALTH AND WELLBEING - YOUR LOCAL GOVT</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1O4wE0Fav0upbuATZEzKwG8iEOKn6boqV/page/yNm9" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_socialvalue = `
<h1>3. SOCIAL VALUE SUMMARY</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1Fo9JHiN1v0nDWPc0dpX_YQ-SVkRi4o4m/page/28q8" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_siteperformance = `
<h1>4. SITE PERFORMANCE (HEAD OFFICE) DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1o-DVPmqwZrzaldEO2JetnMC1fPKl4g9w/page/VqMm" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_groupex = `
<h1>5. PROGRAMS DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1bRASVzoRZY41dzB5JD0LrzBImpf_R_Yf/page/rCRt" frameborder="0" style="border:0" allowfullscreen></iframe>
`
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1cPwt8MqlSQwDhhr_1pD6x5RRRajHCbSQ/page/rCRt" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_covid = `
<h1>8. COVID-19 RECOVERY</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1j0wlPIH9WbsCATjlswPwiPpEilJUbx_m/page/rCRt" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_aqu_dashboard_aquisition = `
<div class="standard-popup">
<h1>ACQUISITION TRACKER</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1R5nfLYr1BQQg-itToX0hH8IQfAAD9Kiw/page/gDr8" frameborder="0" style="border:0" allowfullscreen></iframe>
<br><br>
...
<p><a href="https://docs.google.com/spreadsheets/d/1NKwkYnJP21WDpMcSfa278pnJ4xqT92onQA-udWFuU0U/edit?usp=sharing" target="_blank" style="text-decoration:underline!important;font-weight:bold;">Click here</a> to view SportsEye Operator Data Standards for your account.</p>
`
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'seo_008_mem_dem_cnv_all_SA2',
                legendText: module_mem_submodule1_section4_layer1_legendText,
                hover: module_mem_submodule1_sectionall_layers_area_popup_hover,
              },
              {
                id: 'seo_008_mem_dem_cnv_all_LGA',
                name: 'LGA',
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'seo_008_mem_dem_cnv_swm_SA2',
                legendText: module_mem_submodule2_section4_layer1_legendText,
                hover: module_mem_submodule2_sectionall_layers_area_popup_hover,
              },
              {
                id: 'seo_008_mem_dem_cnv_swm_LGA',
                name: 'LGA',
  ...
  },//END OF MODULE
  {
    ...
    summary: '',
        sections: [
          ...
          // },//END OF SECTION
          {
            heading: '6. PRICING DASHBOARD',
            text: null,
            icon: DASHBOARD_ICON,
            documentHtml: module_key_dashboard_pricing,
          },//END OF SECTION
          {
            heading: '7. COVID-19 RECOVERY',
            text: null,
            icon: DASHBOARD_ICON,
