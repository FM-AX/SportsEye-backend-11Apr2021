...
// 1A. LOGIN SCHREEN
const ACCOUNT_NAME = "SELG_013_AX"
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'selg_013_mem_dem_cnv_SA2',
                legendText: 'Total Demand Conversion (%) in SA2 Area',
                // click: module_lap_area_popup_hover,
                hover: module_lap_area_popup_hover,
              },
              {
                id: 'selg_013_mem_dem_cnv_LGA',
                name: 'LGA',
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA1',
                id: 'selg_013_unmtdem_SA1',
                legendText: 'Projected Unmet Demand in SA1 Area',
                hover: '<p>{AREA_NAME}<p><p>Unmet Demand:</p><h4>{selg_013_unmtdem}</h4>',
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA1',
                id: 'selg_013_chngdem_SA1',
                legendText: 'Change in Demand in SA1 Area',
                hover: '<p>{AREA_NAME}<p><p>Change in Demand:</p><h4>{selg_013_chngdem}</h4>',
              },
            ]
          },//END OF SECTION
        ]
