...
const MAP_START = {
    lat: -36.866337, lng: 174.766582, zoom: 9 //AUCKLAND
}
...
<h4>{AREA_NAME}</h4>
<p>1. Members</p>
<h4>{seo_004_mem_all}</h4>
<p>2. Demand</p>
<h4>{se_leisure_dem}</h4>
<p>3. Conversion</p>
<h4>{seo_004_mem_dem_cnv_all}%</h4>
`
...
<h4>{AREA_NAME}</h4>
<p>1. Members</p>
<h4>{seo_004_mem_swm}</h4>
<p>2. Demand</p>
<h4>{se_swim_dem}</h4>
<p>3. Conversion</p>
<h4>{seo_004_mem_dem_cnv_swm}%</h4>
`
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1chBN9k3j5DI-y7H9CCktJP41ZYv8BM7z/page/cAm9" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_healthwellbeing = `
<h1>2. HEALTH AND WELLBEING - YOUR LOCAL GOVT</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1Pyv5ro_t5YgDPAOkCxXpEHI6r3PbUXeW/page/yNm9" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_socialvalue = `
<h1>3. SOCIAL VALUE SUMMARY</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1AYgQcP2V4592yfEC89dQ7yRrcAPJ0026/page/28q8" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_siteperformance = `
<h1>4. SITE PERFORMANCE (HEAD OFFICE) DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1Ot_gI5UPzAofCJin7sEBrMlfW8TgW7AC/page/VqMm" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_groupex = `
<h1>5. PROGRAMS DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/14XJ-IBoVJUMf2LOL8qXhKaQQtj1fXygG/page/rCRt" frameborder="0" style="border:0" allowfullscreen></iframe>
`
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/19sxUzEf8zpAUoncwGsVSkV5W3355bLyZ/page/rCRt" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_covid = `
<h1>6. COVID-19 RECOVERY</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1172gJLMoEmLTH7tS71l-M7Te8xbFiB41/page/rCRt" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_aqu_dashboard_aquisition = `
<div class="standard-popup">
<h1>ACQUISITION TRACKER</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1dZ7G3LtML_eOuA_W4gJiByHHJMaQvd4u/page/gDr8" frameborder="0" style="border:0" allowfullscreen></iframe>
<br><br>
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/c769fed4-2d76-4e5d-b291-64020e47f4d4/page/6pWGB" frameborder="0" style="border:0" allowfullscreen></iframe>
<br><br>
...
<p><a href="https://docs.google.com/spreadsheets/d/1i_Ms8TFjGxEb-a_zKeumbPYO8MpcvbcMs0Y2rSNbYsY/edit?usp=sharing" target="_blank" style="text-decoration:underline!important;font-weight:bold;">Click here</a> to view SportsEye Operator Data Standards for your account.</p>
`
...
const module_mem_name = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/module_name')
const module_mem_submodule1_name = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule1_name')
const module_mem_submodule1_section1_heading = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule1_section1_heading')
const module_mem_submodule1_section1_layer1_legendText = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule1_section1_layer1_legendText')
const module_mem_submodule1_section1_text = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule1_section1_text')
const module_mem_submodule1_section2_heading = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule1_section2_heading')
const module_mem_submodule1_section2_layer1_legendText = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule1_section2_layer1_legendText')
const module_mem_submodule1_section2_layer2_legendText = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule1_section2_layer2_legendText')
const module_mem_submodule1_section2_text = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule1_section2_text')
const module_mem_submodule1_section3_heading = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule1_section3_heading')
const module_mem_submodule1_section3_layer1_legendText = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule1_section3_layer1_legendText')
const module_mem_submodule1_section3_layer2_legendText = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule1_section3_layer2_legendText')
const module_mem_submodule1_section3_text = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule1_section3_text')
const module_mem_submodule1_section4_heading = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule1_section4_heading')
const module_mem_submodule1_section4_layer1_legendText = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule1_section4_layer1_legendText')
const module_mem_submodule1_section4_layer2_legendText = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule1_section4_layer2_legendText')
const module_mem_submodule1_section4_text = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule1_section4_text')
const module_mem_submodule1_section_layer_details_documentHtml = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule1_section_layer_details_documentHtml')
const module_mem_submodule1_summary = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule1_summary')
const module_mem_submodule2_name = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule2_name')
const module_mem_submodule2_section1_heading = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule2_section1_heading')
const module_mem_submodule2_section1_layer1_legendText = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule2_section1_layer1_legendText')
const module_mem_submodule2_section1_text = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule2_section1_text')
const module_mem_submodule2_section2_heading = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule2_section2_heading')
const module_mem_submodule2_section2_layer1_legendText = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule2_section2_layer1_legendText')
const module_mem_submodule2_section2_layer2_legendText = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule2_section2_layer2_legendText')
const module_mem_submodule2_section2_text = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule2_section2_text')
const module_mem_submodule2_section3_heading = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule2_section3_heading')
const module_mem_submodule2_section3_layer1_legendText = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule2_section3_layer1_legendText')
const module_mem_submodule2_section3_layer2_legendText = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule2_section3_layer2_legendText')
const module_mem_submodule2_section3_text = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule2_section3_text')
const module_mem_submodule2_section4_heading = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule2_section4_heading')
const module_mem_submodule2_section4_layer1_legendText = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule2_section4_layer1_legendText')
const module_mem_submodule2_section4_layer2_legendText = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule2_section4_layer2_legendText')
const module_mem_submodule2_section4_text = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule2_section4_text')
const module_mem_submodule2_section_layer_details_documentHtml = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule2_section_layer_details_documentHtml')
const module_mem_submodule2_summary = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand_nz/submodule2_summary')

// MODULE - AQUISITION RETENTION
const module_aqu_name = require('../group-references/SEO_TEMPLATES/SEO_MODULES/aquistion_retention_nz/module_name')
const module_aqu_submodule1_name = require('../group-references/SEO_TEMPLATES/SEO_MODULES/aquistion_retention_nz/submodule1_name')
const module_aqu_submodule1_summary = require('../group-references/SEO_TEMPLATES/SEO_MODULES/aquistion_retention_nz/submodule1_summary')
const module_aqu_submodule1_section1_heading = require('../group-references/SEO_TEMPLATES/SEO_MODULES/aquistion_retention_nz/submodule1_section1_heading')
const module_aqu_submodule1_section1_layer1_legendText = require('../group-references/SEO_TEMPLATES/SEO_MODULES/aquistion_retention_nz/submodule1_section1_layer1_legendText')
const module_aqu_submodule1_section1_text = require('../group-references/SEO_TEMPLATES/SEO_MODULES/aquistion_retention_nz/submodule1_section1_text')
const module_aqu_submodule1_section2_heading = require('../group-references/SEO_TEMPLATES/SEO_MODULES/aquistion_retention_nz/submodule1_section2_heading')
const module_aqu_submodule1_section2_layer1_legendText = require('../group-references/SEO_TEMPLATES/SEO_MODULES/aquistion_retention_nz/submodule1_section2_layer1_legendText')
const module_aqu_submodule1_section2_layer2_legendText = require('../group-references/SEO_TEMPLATES/SEO_MODULES/aquistion_retention_nz/submodule1_section2_layer2_legendText')
const module_aqu_submodule1_section2_layer3_legendText = require('../group-references/SEO_TEMPLATES/SEO_MODULES/aquistion_retention_nz/submodule1_section2_layer3_legendText')
const module_aqu_submodule1_section2_text = require('../group-references/SEO_TEMPLATES/SEO_MODULES/aquistion_retention_nz/submodule1_section2_text')
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'seo_004_mem_dem_cnv_all_SA2',
                legendText: module_mem_submodule1_section4_layer1_legendText,
                hover: module_mem_submodule1_sectionall_layers_area_popup_hover,
              },
              {
                id: 'seo_004_mem_dem_cnv_all_LGA',
                name: 'LGA',
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'seo_004_mem_dem_cnv_swm_SA2',
                legendText: module_mem_submodule2_section4_layer1_legendText,
                hover: module_mem_submodule2_sectionall_layers_area_popup_hover,
              },
              {
                id: 'seo_004_mem_dem_cnv_swm_LGA',
                name: 'LGA',
