...
// 1A. LOGIN SCHREEN
const ACCOUNT_NAME = "NORTHERN BEACHES"
...
const MAP_START = {
   lat: -33.715, lng: 151.275, zoom: 10 //NORTHERN BEACHES
} 
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1QprQCCMe8A1uI6RlbUBJUvjG4_Fqmyrz/page/HbFMB" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_mem_dashboard_performance = `
<h1>SPORT PERFORMANCE DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1--UftUBWNH1k3Ffw2AKR51ypQMxnTcHc/page/HbFMB" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_mem_dashboard_wellbeing = `
<h1>HEALTH & WELLBEING DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/11-V5AFArqEZ4oMB2KGkUA6ObEXUBgPQ5/page/hzYJB" frameborder="0" style="border:0" allowfullscreen></iframe>
`
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'selg_002_mem_dem_cnv_SA2',
                legendText: 'Total Demand Conversion (%) in SA2 Area',
                // click: module_lap_area_popup_hover,
                hover: module_lap_area_popup_hover,
              },
              {
                id: 'selg_002_mem_dem_cnv_LGA',
                name: 'LGA',
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA1',
                id: 'selg_002_unmtdem_SA1',
                legendText: 'Projected Unmet Demand in SA1 Area',
                hover: '<p>{AREA_NAME}<p><p>Unmet Demand:</p><h4>{selg_002_unmtdem}</h4>',
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA1',
                id: 'selg_002_chngdem_SA1',
                legendText: 'Change in Demand in SA1 Area',
                hover: '<p>{AREA_NAME}<p><p>Change in Demand:</p><h4>{selg_002_chngdem}</h4>',
              },
            ]
          },//END OF SECTION
        ]
