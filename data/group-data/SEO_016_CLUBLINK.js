...
// 01 DEC 2020
// CUSTOM AMENDMENT - ADDED GOLF SECTION BENEATH SWIM SECTION
// NOTE - WHEN DATA COMES ONLINE THE POPUP WILL NEED TO BE AMENDED
...
const MAP_START = {
  lat: -37.912960, lng: 145.136034, zoom: 8 //MELBOURNE
}
...
<h4>{AREA_NAME}</h4>
<p>1. Members</p>
<h4>{seo_016_mem_all}</h4>
<p>2. Demand</p>
<h4>{se_leisure_dem}</h4>
<p>3. Conversion</p>
<h4>{seo_016_mem_dem_cnv_all}%</h4>
`
...
<h4>{AREA_NAME}</h4>
<p>1. Members</p>
<h4>{seo_016_mem_swm}</h4>
<p>2. Demand</p>
<h4>{se_swim_dem}</h4>
<p>3. Conversion</p>
<h4>{seo_016_mem_dem_cnv_swm}%</h4>
`

const module_mem_submodule3_sectionall_layers_site_popup_hover = `
<h4>{site_name}</h4>
`

const module_mem_submodule3_sectionall_layers_area_popup_hover = `
<h4>{AREA_NAME}</h4>
<p>2. Demand</p>
<h4>{se_golf_dem}</h4>
`
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/71bc28f5-ffaf-4632-8303-fc8b8f55046a/page/cAm9" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_healthwellbeing = `
<h1>2. HEALTH AND WELLBEING - YOUR LOCAL GOVT</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/8ea0ff34-9add-413f-b1ec-fc2716521923/page/yNm9" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_socialvalue = `
<h1>3. SOCIAL VALUE SUMMARY</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/ae1b4e2e-6527-48a9-9d2f-9091063c6cc2/page/28q8" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_siteperformance = `
<h1>4. SITE PERFORMANCE (HEAD OFFICE) DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/82760234-637f-4cdb-9673-e52228b69099/page/VqMm" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_groupex = `
<h1>5. PROGRAMS DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/c409ea08-6c3e-46e8-8856-6b15457a40da/page/PiMcB" frameborder="0" style="border:0" allowfullscreen></iframe>
`
...
<h1>6. PRICING DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/8ca16cb7-ed4f-4938-a474-91299cb2c867/page/rCRt" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_key_dashboard_covid = `
<h1>7. COVID-19 RECOVERY</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/4297fc36-107b-41ef-a4c4-a449ec5f31af/page/rCRt" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_aqu_dashboard_aquisition = `
<div class="standard-popup">
<h1>ACQUISITION TRACKER</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/0fa5bda7-eb9e-4bb3-8cad-0e8259b5d783/page/gDr8" frameborder="0" style="border:0" allowfullscreen></iframe>
<br><br>
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/dd3c59cc-0c4e-4221-8d08-93a2d838c083/page/SNYDB" frameborder="0" style="border:0" allowfullscreen></iframe>
<br><br>
...
const module_mem_submodule3_name = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand/submodule3_name')
const module_mem_submodule3_section1_heading = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand/submodule3_section1_heading')
const module_mem_submodule3_section1_layer1_legendText = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand/submodule3_section1_layer1_legendText')
const module_mem_submodule3_section1_text = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand/submodule3_section1_text')
const module_mem_submodule3_section2_heading = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand/submodule3_section2_heading')
const module_mem_submodule3_section2_layer1_legendText = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand/submodule3_section2_layer1_legendText')
const module_mem_submodule3_section2_layer2_legendText = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand/submodule3_section2_layer2_legendText')
const module_mem_submodule3_section2_text = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand/submodule3_section2_text')
const module_mem_submodule3_section3_heading = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand/submodule3_section3_heading')
const module_mem_submodule3_section3_layer1_legendText = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand/submodule3_section3_layer1_legendText')
const module_mem_submodule3_section3_layer2_legendText = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand/submodule3_section3_layer2_legendText')
const module_mem_submodule3_section3_text = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand/submodule3_section3_text')
const module_mem_submodule3_section4_heading = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand/submodule3_section4_heading')
const module_mem_submodule3_section4_layer1_legendText = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand/submodule3_section4_layer1_legendText')
const module_mem_submodule3_section4_layer2_legendText = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand/submodule3_section4_layer2_legendText')
const module_mem_submodule3_section4_text = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand/submodule3_section4_text')
const module_mem_submodule3_section_layer_details_documentHtml = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand/submodule3_section_layer_details_documentHtml')
const module_mem_submodule3_summary = require('../group-references/SEO_TEMPLATES/SEO_MODULES/member_demand/submodule3_summary')
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'seo_016_mem_dem_cnv_all_SA2',
                legendText: module_mem_submodule1_section4_layer1_legendText,
                hover: module_mem_submodule1_sectionall_layers_area_popup_hover,
              },
              {
                id: 'seo_016_mem_dem_cnv_all_LGA',
                name: 'LGA',
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SA2',
                id: 'seo_016_mem_dem_cnv_swm_SA2',
                legendText: module_mem_submodule2_section4_layer1_legendText,
                hover: module_mem_submodule2_sectionall_layers_area_popup_hover,
              },
              {
                id: 'seo_016_mem_dem_cnv_swm_LGA',
                name: 'LGA',
      ...
      **/
      {
        ...
        id: 'module_b3',
        image: PRIMARY_MENU_IMAGE,
        summary: module_mem_submodule3_summary,
        sections: [
          {
            heading: module_mem_submodule3_section1_heading,
            text: module_mem_submodule3_section1_text,
            icon: POINT_ICON,
            layers: [
              {
                name: 'SITE',
                id: 'seo_016_golf_SITE',
                legendText: module_mem_submodule3_section1_layer1_legendText,
                hover: module_mem_submodule3_sectionall_layers_site_popup_hover,
              },
            ]
          },//END OF SECTION
          {
            heading: module_mem_submodule3_section2_heading,
            text: module_mem_submodule3_section2_text,
            icon: AREA_ICON,
            layers: [
              {
                name: 'SA2',
                id: 'seo_016_mem_golf_SA2',
                legendText: module_mem_submodule3_section2_layer1_legendText,
                hover: module_mem_submodule3_sectionall_layers_area_popup_hover,
              },
              {
                id: 'seo_016_mem_golf_LGA',
                name: 'LGA',
                legendText: module_mem_submodule3_section2_layer2_legendText,
                hover: module_mem_submodule3_sectionall_layers_area_popup_hover,
              },
            ]
          },//END OF SECTION
          {
            heading: module_mem_submodule3_section3_heading,
            text: module_mem_submodule3_section3_text,
            icon: AREA_ICON,
            layers: [
              {
                name: 'SA2',
                id: 'se_golf_dem_SA2',
                legendText: module_mem_submodule3_section3_layer1_legendText,
                hover: module_mem_submodule3_sectionall_layers_area_popup_hover,
              },
              {
                id: 'se_golf_dem_LGA',
                name: 'LGA',
                legendText: module_mem_submodule3_section3_layer2_legendText,
                hover: module_mem_submodule3_sectionall_layers_area_popup_hover,
              },
            ]
          },//END OF SECTION
          {
            heading: module_mem_submodule3_section4_heading,
            text: module_mem_submodule3_section4_text,
            icon: AREA_ICON,
            layers: [
              {
                name: 'SA2',
                id: 'seo_016_mem_dem_cnv_golf_SA2',
                legendText: module_mem_submodule3_section4_layer1_legendText,
                hover: module_mem_submodule3_sectionall_layers_area_popup_hover,
              },
              {
                id: 'seo_016_mem_dem_cnv_golf_LGA',
                name: 'LGA',
                legendText: module_mem_submodule3_section4_layer2_legendText,
                hover: module_mem_submodule3_sectionall_layers_area_popup_hover,
              },
            ]
          },//END OF SECTION
          {
            ...
            text: null,
            icon: DOCUMENT_ICON,
            documentHtml: module_mem_submodule3_section_layer_details_documentHtml,
          },//END OF SECTION
        ]
      },//END OF SUB-MODULE
    ]
