...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/846cd745-8dae-48ce-bd0f-c31e80f8d4c4/page/HbFMB" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_mem_dashboard_performance = `
<h1>SPORT PERFORMANCE DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/bb2816a7-7d82-4aea-b0a3-153a1515c745/page/mZ1r" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_mem_dashboard_wellbeing = `
<h1>HEALTH & WELLBEING DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/f91dbbb0-80a4-4d3f-ad94-cf2915c37216/page/KO0mB" frameborder="0" style="border:0" allowfullscreen></iframe>
`
            ...
            layers: [
              {
                ...
                legendText: 'TENNIS QLD Members in SA2 Area',
                // click: TBC,
              ...
              },
              {
                ...
                name: 'LGA',
                legendText: 'TENNIS QLD Members in LGA Area',
                // click: TBC,
                hover: module_mem_sec_007_tenn_area_popup_hover
              },
              {
                ...
                name: 'REGION',
                legendText: 'TENNIS QLD Members in Govt. Region',
                // click: TBC,
                hover: module_mem_sec_007_tenn_area_popup_hover
              },
            ]
            ...
            layers: [
              {
                ...
                legendText: 'TENNIS QLD Demand in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_007_tenn_area_popup_hover
              },
              {
                ...
                name: 'LGA',
                legendText: 'TENNIS QLD Demand in LGA Area',
                // click: TBC,
                hover: module_mem_sec_007_tenn_area_popup_hover
              },
              {
                ...
                name: 'REGION',
                legendText: 'TENNIS QLD Demand in Govt. Region',
                // click: TBC,
                hover: module_mem_sec_007_tenn_area_popup_hover
              },
            ]
            ...
            layers: [
              {
                ...
                legendText: 'TENNIS QLD Demand Conversion (%) in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_007_tenn_area_popup_hover
              },
              {
                ...
                name: 'LGA',
                legendText: 'TENNIS QLD Demand Conversion (%) in LGA Area',
                // click: TBC,
                hover: module_mem_sec_007_tenn_area_popup_hover
              },
              {
                ...
                name: 'REGION',
                legendText: 'TENNIS QLD Demand Conversion (%) in Govt. Region',
                // click: TBC,
                hover: module_mem_sec_007_tenn_area_popup_hover
              },
            ]
            ...
            layers: [
              {
                ...
                legendText: 'TENNIS QLD Clubs and Members at Site',
                // click: TBC,
