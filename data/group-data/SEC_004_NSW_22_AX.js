...
// 1A. LOGIN SCHREEN
const ACCOUNT_NAME = "ROYAL LIFE SAVING SOCIETY AUSTRALIA"
...
const module_mem_sec_004_ax_22_area_popup_hover = require('../group-references/SEC_FILES/SEC_004_NSW/my_members/ax_22/area_popup_hover')


// 2. DASHBOARDS

const module_mem_dashboard_summary = `
<h1>POOL PROVISION DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/ef75269c-82e5-4d59-b0e3-2177b7971c8d/page/1M" frameborder="0" style="border:0" allowfullscreen></iframe>
`
...
const module_mem_site_popup_hover_rlssa = require('../group-references/SEC_FILES/SEC_004_NSW/my_members/site_popup_hover_rlssa')
...
const CATEGORIES = [
  {
    ...
    summary: module_mem_module_summary,
        sections: [
          {
            heading: '1. AQUATIC DEMAND',
         /**   text: module_mem_section1_text, **/
            icon: AREA_ICON,
            layers: [
              {
                name: 'SA2',
                id: 'sec_004_ax_22_mem_SA2',
                legendText: 'RLSSA Aquatic Demand in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_004_ax_22_area_popup_hover
              },
              {
                id: 'sec_004_ax_22_mem_LGA',
                name: 'LGA',
                legendText: 'RLSSA Aquatic Demand in LGA Area',
                // click: TBC,
                hover: module_mem_sec_004_ax_22_area_popup_hover
              },
              {
                id: 'sec_004_ax_22_mem_REG',
                name: 'REGION',
                legendText: 'RLSSA Aquatic Demand in Govt. Region',
                // click: TBC,
                hover: module_mem_sec_004_ax_22_area_popup_hover
              },
          ...
          {
            heading: '2. AQUATIC UNMET DEMAND',
          /**  text: module_mem_section2_text, **/
            icon: AREA_ICON,
            layers: [
              {
                name: 'SA2',
                id: 'sec_004_ax_22_dem_SA2',
                legendText: 'RLSSA Aquatic Unmet Demand in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_004_ax_22_area_popup_hover
              },
              {
                id: 'sec_004_ax_22_dem_LGA',
                name: 'LGA',
                legendText: 'RLSSA Aquatic Unmet Demand in LGA Area',
                // click: TBC,
                hover: module_mem_sec_004_ax_22_area_popup_hover
              },
              {
                id: 'sec_004_ax_22_dem_REG',
                name: 'REGION',
                legendText: 'RLSSA Aquatic Unmet Demand in Govt. Region',
                // click: TBC,
                hover: module_mem_sec_004_ax_22_area_popup_hover
              },
          ...
          {
            heading: '3. SWIM SCHOOL DEMAND',
          /**  text: module_mem_section3_text, **/
            icon: AREA_ICON,
            layers: [
              {
                name: 'SA2',
                id: 'sec_004_ax_22_mem_dem_cnv_SA2',
                legendText: 'RLSSA Aquatic Swim School Demand in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_004_ax_22_area_popup_hover
              },
              {
                id: 'sec_004_ax_22_mem_dem_cnv_LGA',
                name: 'LGA',
                legendText: 'RLSSA Aquatic Swim School Demand in LGA Area',
                // click: TBC,
                hover: module_mem_sec_004_ax_22_area_popup_hover
              },
              {
                id: 'sec_004_ax_22_mem_dem_cnv_REG',
                name: 'REGION',
                legendText: 'RLSSA Aquatic Swim School Demand in Govt. Region',
                // click: TBC,
                hover: module_mem_sec_004_ax_22_area_popup_hover
              },
          ...
          /**  text: module_mem_section4_text,**/
            ...
            layers: [
              {
                name: 'SITE',
                id: 'sec_004_ax_22_SITE',
                legendText: 'Infrastructure Sites (Swimming Pool)',
                // click: TBC,
                hover: module_mem_site_popup_hover_rlssa
              },
            ]
          },//END OF SECTION
          {
            heading: '5. POOL PROVISION DASHBOARD',
            text: null,
            icon: DASHBOARD_ICON,
