...
// SEP-002-v1.2-NETBALLNSW
const MAPBOX_STYLE = "mapbox://styles/activexchange-prod/ck3p85tdw0go21dmqkz5w4d43" 
...
// 1. POPUPS
const CLICK_ENGAGEMENT_AREA_PARTICIPATION = require('../group-references/SEP_002_NETBALLNSW/CLICK_ENGAGEMENT_AREA_PARTICIPATION')
const CLICK_ENGAGEMENT_AREA_OTHER = require('../group-references/SEP_002_NETBALLNSW/CLICK_ENGAGEMENT_AREA_OTHER')
const CLICK_RESOURCES_PROVISION = require('../group-references/SEP_002_NETBALLNSW/CLICK_RESOURCES_PROVISION')
const CLICK_RESOURCES_SITE = require('../group-references/SEP_002_NETBALLNSW/CLICK_RESOURCES_SITE')


// 2. DASHBOARDS
const DATA_SCORECARD = require('../group-references/SEP_002_NETBALLNSW/DATA_SCORECARD')
const DATA_STUDIO = require('../group-references/SEP_002_NETBALLNSW/DATA_STUDIO')
...
const GAP_DASHBOARD = require('../group-references/SEP_002_NETBALLNSW/GAP_DASHBOARD')
...
<b>Colour: Court Type</b><br>
Green: Competition<br>Blue: Training<br><br>
<b>Size: Total Capacity at Site</b>
`
const AREA_CATCHMENT_DT_TEXT = `
<b>Colour: Drive Time to Closest Facility</b><br>
Total 16.5 Minute Catchment from all Facilities<br><br>
<b>View: SA1 Area</b>
`
const AREA_FCLT_COUNT_TEXT = `
<b>Colour: Total Capacity of Competition Courts in Area.</b><br>
`
const AREA_PROV_MEM_TEXT = `
<b>Colour: Ratio of Participants to Competition Court Capacity</b><br>
Total Participants / Competition Court Capacity
`
const AREA_PROV_DEM_TEXT = `
<b>Colour: Ratio of Demand to Competition Court Capacity</b><br>
Total Demand / Competition Court Capacity
`
const AREA_PROV_POP_TEXT = `
<b>Colour: Ratio of Population to Competition Court Capacity</b><br>
Total Population / Competition Court Capacity
`

const SITE_EVENTS_TEXT = `
<b>Colour: Category</b><br>
Blue: Type A<br>Yellow: Type B<br>
...
<p>Potential Netball NSW Sites</p>
`
const SITE_UNUSED_TEXT = `
<p>Unused Netball NSW Sites</p>
`

const AREA_GAP_TYPEA = `
<b>Colour: Modelled Gap</b><br>
Based on Competition Courts
`
...
Blue: New Type A<br>Green: New Type B Aass<br>Light Blue: Upgrade Type B<br>Pink: Upgrade Other
`
...
const STATE_SUMMARY = require('../group-references/SEP_002_NETBALLNSW/STATE_SUMMARY')

const REPORT_STRATEGIC_CONTEXT_INTRODUCTION = require('../group-references/SEP_002_NETBALLNSW/REPORT_STRATEGIC_CONTEXT_INTRODUCTION')
const REPORT_STRATEGIC_CONTEXT_INDUSTRY = require('../group-references/SEP_002_NETBALLNSW/REPORT_STRATEGIC_CONTEXT_INDUSTRY')
const REPORT_STRATEGIC_CONTEXT_GOVT = require('../group-references/SEP_002_NETBALLNSW/REPORT_STRATEGIC_CONTEXT_GOVT')
const REPORT_STRATEGIC_CONTEXT_SPRT = require('../group-references/SEP_002_NETBALLNSW/REPORT_STRATEGIC_CONTEXT_SPRT')
const REPORT_STRATEGIC_CONTEXT_STAKEHOLDER = require('../group-references/SEP_002_NETBALLNSW/REPORT_STRATEGIC_CONTEXT_STAKEHOLDER')
const REPORT_STRATEGIC_VISION_PRIORITIES = require('../group-references/SEP_002_NETBALLNSW/REPORT_STRATEGIC_VISION_PRIORITIES')
const REPORT_STRATEGIC_VISION_FRAMEWORK = require('../group-references/SEP_002_NETBALLNSW/REPORT_STRATEGIC_VISION_FRAMEWORK')
const REPORT_STRATEGIC_VISION_TARGETS = require('../group-references/SEP_002_NETBALLNSW/REPORT_STRATEGIC_VISION_TARGETS')
      ...
      },//END OF SECTION GROUP
      {
        ...
        sections: [
          ...
          },//END OF SECTION
          {
            ...
            text: AREA_MEM_GRPA_TEXT,
            icon: AREA_ICON,
            layers: [
              {
                id: 'AREA_MEM_GRPA_REG',
                name: 'GOV REGION',
                legendText: 'Alternative Season Participants in Govt. Region',
                hover: '<h4>{AREA_NAME}</h4><p>Participants:</p><h4>{AREA_MEM_GRPA}</h4>',
                // click: CLICK_ENGAGEMENT_AREA_PARTICIPATION,
              },
              {
                id: 'AREA_MEM_GRPA_LGA',
                name: 'LGA',
            ...
            layers: [
              {
                ...
                hover: '<h4>{SITE_NAME}</h4><p>Capacity:</p><h4>{PROVISION_RATIO_COUNT}</h4><i>Click to view full site details</i>',
            ...
            layers: [
              {
                ...
                name: 'GOV REGION',
                legendText: 'Total Capacity of Competition Courts in Govt. Region',
                hover: '<h4>{AREA_NAME}</h4><p>Capacity:</p><h4>{AREA_FACL_ASSET_COUNT}</h4><p>Competition Facilities:<p><h4>{AREA_FACL_COUNT}</h4>',
              },
              {
                id: 'AREA_FACL_COUNT_LGA',
                name: 'LGA',
                legendText: 'Total Capacity of Competition Courts in LGA Area',
                hover: '<h4>{AREA_NAME}</h4><p>Capacity:</p><h4>{AREA_FACL_ASSET_COUNT}</h4><p>Competition Facilities:<p><h4>{AREA_FACL_COUNT}</h4>',
              },
            ]
          },//END OF SECTION
            ...
            layers: [
              {
                ...
                name: 'GOV REGION',
                legendText: 'Ratio of Members to Competition Court Capacity in Govt. Region',
              ...
              },
              {
                ...
                name: 'LGA',
                legendText: 'Ratio of Members to Competition Court Capacity in LGA Area',
                hover: '<h4>{AREA_NAME}</h4><p>Ratio:</p><h4>{AREA_PROV_MEM}</h4><i>Click to view full site details</i>',
                click: CLICK_RESOURCES_PROVISION,
              },
            ]
            ...
            layers: [
              {
                ...
                name: 'GOV REGION',
                legendText: 'Ratio of Demand to Competition Court Capacity in Govt. Region',
              ...
              },
              {
                ...
                name: 'LGA',
                legendText: 'Ratio of Demand to Competition Court Capacity in LGA Area',
                hover: '<h4>{AREA_NAME}</h4><p>Ratio:</p><h4>{AREA_PROV_DEM}</h4><i>Click to view full site details</i>',
                click: CLICK_RESOURCES_PROVISION,
              },
            ]
            ...
            layers: [
              {
                ...
                name: 'GOV REGION',
                legendText: 'Ratio of Population to Competition Court Capacity in Govt. Region',
              ...
              },
              {
                ...
                name: 'LGA',
                legendText: 'Ratio of Population to Competition Court Capacity in LGA Area',
                hover: '<h4>{AREA_NAME}</h4><p>Ratio:</p><h4>{AREA_PROV_POP}</h4><i>Click to view full site details</i>',
                click: CLICK_RESOURCES_PROVISION,
              },
            ]
    ...
    CODES: [
      ...
      },//END OF SECTION GROUP
      {
        ...
        sections: [
          ...
          {
            heading: '3. PARTNER OPPORTUNITIES - DEMO',
          ...
          {
            heading: '4. POTENTIAL SCHOOLS - DEMO',
