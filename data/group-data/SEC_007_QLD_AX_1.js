...
// 1A. LOGIN SCHREEN
const ACCOUNT_NAME = "Rugby Union QLD"
...
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/2b112444-7e3e-4fd4-ae0a-7664ef651cce/page/HbFMB" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_mem_dashboard_performance = `
<h1>SPORT PERFORMANCE DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/aa638fa5-d585-468b-9e33-15af41b49a68/page/mZ1r" frameborder="0" style="border:0" allowfullscreen></iframe>
`

const module_mem_dashboard_wellbeing = `
<h1>HEALTH & WELLBEING DASHBOARD</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/77aa3248-c007-4792-8c58-cf769802990c/page/EsJxB" frameborder="0" style="border:0" allowfullscreen></iframe>
`
            ...
            layers: [
              {
                ...
                legendText: 'Rugby Union QLD Members in SA2 Area',
                // click: TBC,
              ...
              },
              {
                ...
                name: 'LGA',
                legendText: 'Rugby Union QLD Members in LGA Area',
                // click: TBC,
                hover: module_mem_sec_007_ax_1_area_popup_hover
              },
              {
                ...
                name: 'REGION',
                legendText: 'Rugby Union QLD Members in Govt. Region',
                // click: TBC,
                hover: module_mem_sec_007_ax_1_area_popup_hover
              },
            ]
            ...
            layers: [
              {
                ...
                legendText: 'Rugby Union QLD Demand in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_007_ax_1_area_popup_hover
              },
              {
                ...
                name: 'LGA',
                legendText: 'Rugby Union QLD Demand in LGA Area',
                // click: TBC,
                hover: module_mem_sec_007_ax_1_area_popup_hover
              },
              {
                ...
                name: 'REGION',
                legendText: 'Rugby Union QLD Demand in Govt. Region',
                // click: TBC,
                hover: module_mem_sec_007_ax_1_area_popup_hover
              },
            ]
            ...
            layers: [
              {
                ...
                legendText: 'Rugby Union QLD Demand Conversion (%) in SA2 Area',
                // click: TBC,
                hover: module_mem_sec_007_ax_1_area_popup_hover
              },
              {
                ...
                name: 'LGA',
                legendText: 'Rugby Union QLD Demand Conversion (%) in LGA Area',
                // click: TBC,
                hover: module_mem_sec_007_ax_1_area_popup_hover
              },
              {
                ...
                name: 'REGION',
                legendText: 'Rugby Union QLD Demand Conversion (%) in Govt. Region',
                // click: TBC,
                hover: module_mem_sec_007_ax_1_area_popup_hover
              },
            ]
            ...
            layers: [
              {
                ...
                legendText: 'Rugby Union QLD Clubs and Members at Site',
                // click: TBC,
