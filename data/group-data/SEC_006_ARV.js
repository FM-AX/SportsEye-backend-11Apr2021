...
// 1A. LOGIN SCHREEN
const ACCOUNT_NAME = "AQUATICS & RECREATION VICTORIA"
...
<h4>{sec_006_dem}</h4>
<p>Conversion</p>
<h4>{sec_006_mem_dem_cnv}%</h4>
`

// 2. DASHBOARDS

const module_mem_dashboard_vicswim = `
<h1>VICSWIM</h1>
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1f53b6c2-74bf-4d50-954f-ab6cb396dd4e/page/AkzpB" frameborder="0" style="border:0" allowfullscreen></iframe>
`


// 3. LAYER TEXT

const module_mem_section_site_text = `
<b>Size: Students</b>
`

const module_mem_section_mem_text = `
<b>Colour: Total Students</b>
`

const module_mem_section_dem_text = `
<b>Colour: Total Demand</b>
`

const module_mem_section_cnv_text = `
<b>Colour: Conversion %</b><br>
Total Students / Total Demand
`
...
const CATEGORIES = [
  {
    ...
    summary: '<p>Select layers below to display on the map.</p>',
        sections: [
           {
            heading: '1. VENUE PARTICIPANTS (2021)',
            text: module_mem_section_site_text,
            icon: POINT_ICON,
            layers: [
              {
                name: 'Site',
                id: 'sec_006_SITE',
                legendText: 'ARV Members at Site',
                // click: TBC,
          ...
          {
            heading: '2. STUDENTS (2021)',
            text: module_mem_section_mem_text,
            icon: AREA_ICON,
            layers: [
              {
                name: 'SA2',
                id: 'sec_006_mem_SA2',
                legendText: 'ARV Students in SA2 Area',
                // click: TBC,
              ...
              },
              {
                id: 'sec_006_mem_LGA',
                name: 'LGA',
                legendText: 'ARV Students in LGA Area',
                // click: TBC,
                hover: module_mem_area_popup_hover
              },
              {
                id: 'sec_006_mem_REG',
                name: 'REGION',
                legendText: 'ARV Students in Govt. Region',
                // click: TBC,
                hover: module_mem_area_popup_hover
              },
            ]
          ...
          {
            heading: '3. DEMAND (2021)',
            text: module_mem_section_dem_text,
            icon: AREA_ICON,
            layers: [
              {
                name: 'SA2',
                id: 'sec_006_dem_SA2',
                legendText: 'ARV Demand in SA2 Area',
                // click: TBC,
                hover: module_mem_area_popup_hover
              },
              {
                id: 'sec_006_dem_LGA',
                name: 'LGA',
                legendText: 'ARV Demand in LGA Area',
                // click: TBC,
                hover: module_mem_area_popup_hover
              },
              {
                id: 'sec_006_dem_REG',
                name: 'REGION',
                legendText: 'ARV Demand in Govt. Region',
                // click: TBC,
                hover: module_mem_area_popup_hover
              },
            ]
          ...
          {
            heading: '4. CONVERSION (2021)',
            text: module_mem_section_cnv_text,
            icon: AREA_ICON,
            layers: [
              {
                name: 'SA2',
                id: 'sec_006_mem_dem_cnv_SA2',
                legendText: 'ARV Demand Conversion (%) in SA2 Area',
                // click: TBC,
                hover: module_mem_area_popup_hover
              },
              {
                id: 'sec_006_mem_dem_cnv_LGA',
                name: 'LGA',
                legendText: 'ARV Demand Conversion (%) in LGA Area',
                // click: TBC,
                hover: module_mem_area_popup_hover
              },
              {
                id: 'sec_006_mem_dem_cnv_REG',
                name: 'REGION',
                legendText: 'ARV Demand Conversion (%) in Govt. Region',
                // click: TBC,
                hover: module_mem_area_popup_hover
              },
            ]
          ...
          {
            heading: '5. VICSWIM DASHBOARD',
            text: null,
            icon: DASHBOARD_ICON,
            documentHtml: module_mem_dashboard_vicswim,
          },//END OF SECTION
        ]
  },//END OF MODULE
  {
