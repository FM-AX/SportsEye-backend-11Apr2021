...
// 1A. LOGIN SCHREEN
const ACCOUNT_NAME = "ATHLETICS NSW"
...
// SEP-001-v1.2-ATHL-11NOV19
const MAPBOX_STYLE = "mapbox://styles/activexchange-prod/ck3mc52rn0t261cp6ha1g0v8z" 
...
// 1. POPUPS
const CLICK_ENGAGEMENT_AREA_PARTICIPATION = require('../group-references/SEP_001_ATHLETICSNSW/CLICK_ENGAGEMENT_AREA_PARTICIPATION')
const CLICK_ENGAGEMENT_AREA_OTHER = require('../group-references/SEP_001_ATHLETICSNSW/CLICK_ENGAGEMENT_AREA_OTHER')
const CLICK_RESOURCES_PROVISION = require('../group-references/SEP_001_ATHLETICSNSW/CLICK_RESOURCES_PROVISION')
const CLICK_RESOURCES_SITE = require('../group-references/SEP_001_ATHLETICSNSW/CLICK_RESOURCES_SITE')

const CLICK_GROWTH_OPP_SITE = require('../group-references/SEP_001_ATHLETICSNSW/CLICK_GROWTH_OPP_SITE')
const CLICK_IMPLEMENTATION_PRI_AREA = require('../group-references/SEP_001_ATHLETICSNSW/CLICK_IMPLEMENTATION_PRI_AREA')
const CLICK_IMPLEMENTATION_PRI_SITE = require('../group-references/SEP_001_ATHLETICSNSW/CLICK_IMPLEMENTATION_PRI_SITE')



// 2. DASHBOARDS
const DATA_SCORECARD = require('../group-references/SEP_001_ATHLETICSNSW/DATA_SCORECARD')
const DATA_STUDIO = require('../group-references/SEP_001_ATHLETICSNSW/DATA_STUDIO')
...
const TABLE_PRIORITIES = require('../group-references/SEP_001_ATHLETICSNSW/TABLE_PRIORITIES')
const GAP_DASHBOARD = require('../group-references/SEP_001_ATHLETICSNSW/GAP_DASHBOARD')

const module_stateofsport_dashboard_sportsummary = `
<iframe width="700" height="500" src="https://datastudio.google.com/embed/reporting/1fAtDfykY8BKTeOd_VxMMY-cSqmsmNlb1/page/HbFMB" frameborder="0" style="border:0" allowfullscreen></iframe>
`
...
Blue: Little Athletics<br>Yellow: Athletics<br>Green: Both<br>Black: Neither<br><br>
<b>Size: Total Participants</b>
`
const AREA_MEM_ALL_TEXT = `
<b>Colour: Total Participants ('athletes')</b>
`
...
Difference between 2017/18 Participants and 2016/17 Participants 
`
...
<b>Colour: Track Type</b><br>
Green: Grass<br>Blue: Synthetic<br><br>
`
...
<b>Colour: Total Count of Facilities in Area.</b><br>
`
const AREA_PROV_MEM_TEXT = `
<b>Colour: Ratio of Participants to Facilities</b><br>
Total Participants / Facility Count
`
const AREA_PROV_DEM_TEXT = `
<b>Colour: Ratio of Demand to Facilities</b><br>
Total Demand / Facility Count
`
const AREA_PROV_POP_TEXT = `
<b>Colour: Ratio of Population to Facilities</b><br>
...
<p>Potential Athletics NSW Sites</p>
`
const SITE_UNUSED_TEXT = `
<p>Unused Athletics NSW Sites</p>
`

const AREA_GAP_TYPEA = `
<b>Colour: Modelled Gap</b><br>
Based on Standard Facilities
`

const AREA_GAP_TYPEB = `
<b>Colour: Modelled Gap</b><br>
Based on Synthetic Facilities
`
...
Blue: New Synthetic<br>Green: New Grass<br>Light Blue: Upgrade Synthetic<br>Pink: Upgrade Other
`

const SITE_PRIORITIES_TEXT = `
<b>Colour: Project Type</b><br>
Blue: New Synthetic<br>Green: New Grass<br>Light Blue: Upgrade Synthetic<br>Pink: Upgrade Other
`

// 4. DOCUMENTS
const STATE_SUMMARY = require('../group-references/SEP_001_ATHLETICSNSW/STATE_SUMMARY')

const REPORT_STRATEGIC_CONTEXT_INTRODUCTION = require('../group-references/SEP_001_ATHLETICSNSW/REPORT_STRATEGIC_CONTEXT_INTRODUCTION')
const REPORT_STRATEGIC_CONTEXT_INDUSTRY = require('../group-references/SEP_001_ATHLETICSNSW/REPORT_STRATEGIC_CONTEXT_INDUSTRY')
const REPORT_STRATEGIC_CONTEXT_GOVT = require('../group-references/SEP_001_ATHLETICSNSW/REPORT_STRATEGIC_CONTEXT_GOVT')
const REPORT_STRATEGIC_CONTEXT_SPRT = require('../group-references/SEP_001_ATHLETICSNSW/REPORT_STRATEGIC_CONTEXT_SPRT')
const REPORT_STRATEGIC_CONTEXT_STAKEHOLDER = require('../group-references/SEP_001_ATHLETICSNSW/REPORT_STRATEGIC_CONTEXT_STAKEHOLDER')
const REPORT_STRATEGIC_VISION_PRIORITIES = require('../group-references/SEP_001_ATHLETICSNSW/REPORT_STRATEGIC_VISION_PRIORITIES')
const REPORT_STRATEGIC_VISION_FRAMEWORK = require('../group-references/SEP_001_ATHLETICSNSW/REPORT_STRATEGIC_VISION_FRAMEWORK')
const REPORT_STRATEGIC_VISION_TARGETS = require('../group-references/SEP_001_ATHLETICSNSW/REPORT_STRATEGIC_VISION_TARGETS')
...
const CATEGORIES = [
  {
    ...
    CODES: [
      {
        name: 'STATE OF ATHLETICS IN NSW',
        id: '1A_SUMMARY',
            ...
            layers: [
              {
                name: 'SITE',
                id: 'SITE_OVERVIEW',
                legendText: 'Athletics NSW Sites',
            ...
            layers: [
              {
                ...
                hover: '<h4>{AREA_NAME}</h4><p>Total Demand Conversion:</p><h4>{AREA_DEM_CNV_ALL}%</h4><p>14 and Under:</p><h4>{AREA_DEM_CNV_GRPC}%</h4><p>15 and Over:</p><h4>{AREA_DEM_CNV_GRPD}%</h4>',
              },
            ]
          },//END OF SECTION
          {
            ...
            layers: [
              {
                name: 'SITE',
                id: 'SITE_MEM_ALL',
                legendText: 'Total Participants at Site',
            ...
            layers: [
              {
                ...
                hover: '<h4>{AREA_NAME}</h4><p>Total Demand:</p><h4>{AREA_DEM_ALL}</h4><p>14 and Under:</p><h4>{AREA_DEM_GRPC}</h4><p>15 and Over:</p><h4>{AREA_DEM_GRPD}</h4><i>Click to view full site details</i>',
            ...
            layers: [
              {
                ...
                hover: '<h4>{AREA_NAME}</h4><p>Total Demand Conversion:</p><h4>{AREA_DEM_CNV_ALL}%</h4><p>14 and Under:</p><h4>{AREA_DEM_CNV_GRPC}%</h4><p>15 and Over:</p><h4>{AREA_DEM_CNV_GRPD}%</h4><i>Click to view full site details</i>',
                click: CLICK_ENGAGEMENT_AREA_OTHER,
              },
              {
            ...
            layers: [
              {
                ...
                hover: '<h4>{AREA_NAME}</h4><p>Demand Difference:</p><h4>{AREA_DEM_DIF_ALL}</h4><p>14 and Under:</p><h4>{AREA_DEM_DIF_GRPC}</h4><p>15 and Over:</p><h4>{AREA_DEM_DIF_GRPD}</h4><i>Click to view full site details</i>',
                click: CLICK_ENGAGEMENT_AREA_OTHER,
              },
              {
            ...
            layers: [
              {
                ...
                hover: '<h4>{SITE_NAME}</h4><i>Click to view full site details</i>',
            ...
            layers: [
              {
                ...
                name: 'GOV REGION',
                legendText: 'Count of Facilities in Govt. Region',
                hover: '<h4>{AREA_NAME}</h4><p>FACILITIES</p><h4>{AREA_FACL_COUNT}</h4>',
                // click: CLICK_RESOURCES_PROVISION,
              },
              {
                id: 'AREA_FACL_COUNT_LGA',
                name: 'LGA',
                legendText: 'Count of Facilities in LGA Area',
                hover: '<h4>{AREA_NAME}</h4><p>FACILITIES</p><h4>{AREA_FACL_COUNT}</h4>',
                // click: CLICK_RESOURCES_PROVISION,
              },
            ]
            ...
            layers: [
              {
                ...
                name: 'GOV REGION',
                legendText: 'Ratio of Members to Facilities in Govt. Region',
                hover: '<h4>{AREA_NAME}</h4><p>RATIO</p><h4>{AREA_PROV_MEM}</h4><i>Click to view full site details</i>',
                click: CLICK_RESOURCES_PROVISION,
              },
              {
                id: 'AREA_PROV_MEM_LGA',
                name: 'LGA',
                legendText: 'Ratio of Members to Facilities in LGA Area',
                hover: '<h4>{AREA_NAME}</h4><p>RATIO</p><h4>{AREA_PROV_MEM}</h4><i>Click to view full site details</i>',
                click: CLICK_RESOURCES_PROVISION,
              },
            ]
            ...
            layers: [
              {
                ...
                name: 'GOV REGION',
                legendText: 'Ratio of Demand to Facilities in Govt. Region',
                hover: '<h4>{AREA_NAME}</h4><p>RATIO</p><h4>{AREA_PROV_DEM}</h4><i>Click to view full site details</i>',
                click: CLICK_RESOURCES_PROVISION,
              },
              {
                id: 'AREA_PROV_DEM_LGA',
                name: 'LGA',
                legendText: 'Ratio of Demand to Facilities in LGA Area',
                hover: '<h4>{AREA_NAME}</h4><p>RATIO</p><h4>{AREA_PROV_DEM}</h4><i>Click to view full site details</i>',
                click: CLICK_RESOURCES_PROVISION,
              },
            ]
            ...
            layers: [
              {
                ...
                name: 'GOV REGION',
                legendText: 'Ratio of Population to Facilities in Govt. Region',
                hover: '<h4>{AREA_NAME}</h4><p>RATIO</p><h4>{AREA_PROV_POP}</h4><i>Click to view full site details</i>',
                click: CLICK_RESOURCES_PROVISION,
              },
              {
                id: 'AREA_PROV_POP_LGA',
                name: 'LGA',
                legendText: 'Ratio of Population to Facilities in LGA Area',
                hover: '<h4>{AREA_NAME}</h4><p>RATIO</p><h4>{AREA_PROV_POP}</h4><i>Click to view full site details</i>',
                click: CLICK_RESOURCES_PROVISION,
              },
            ]
  ...
  },//END OF MODULE
  {
    ...
    CODES: [
      ...
      },//END OF SECTION GROUP
      {
        ...
        sections: [
          {
            heading: '1A. GAP MODELLING - STANDARD 2026',
            text: AREA_GAP_TYPEA,
            icon: AREA_ICON,
            layers: [
              {
                id: 'GAP_TYPEA_26_REG',
                name: 'GOV REGION',
                legendText: '2026 Standard Gap in Govt. Region',
              ...
              },
              {
                id: 'GAP_TYPEA_26_LGA',
                name: 'LGA',
                legendText: '2026 Standard Gap in LGA Area',
                hover: '<h4>{AREA_NAME}</h4><p>Standard Gap 2016:</p><h4>{GAP_TYPEA_16}</h4><p>Standard Gap 2026:</p><h4>{GAP_TYPEA_26}</h4><p>Standard Gap 2036:</p><h4>{GAP_TYPEA_36}</h4>',
              },
            ]
          },//END OF SECTION
          {
            heading: '1B. GAP MODELLING - SYNTHETIC 2026',
            text: AREA_GAP_TYPEB,
            icon: AREA_ICON,
            layers: [
              {
                id: 'GAP_TYPEB_26_REG',
                name: 'GOV REGION',
                legendText: '2026  Synthetic Gap in Govt. Region',
                hover: '<h4>{AREA_NAME}</h4><p>Synthetic Gap 2016:</p><h4>{GAP_TYPEB_16}</h4><p>Synthetic Gap 2026:</p><h4>{GAP_TYPEB_26}</h4><p>Synthetic Gap 2036:</p><h4>{GAP_TYPEB_36}</h4>',
              },
              {
                id: 'GAP_TYPEB_26_LGA',
                name: 'LGA',
                legendText: '2026 Synthetic Gap in LGA Area',
                hover: '<h4>{AREA_NAME}</h4><p>Synthetic Gap 2016:</p><h4>{GAP_TYPEB_16}</h4><p>Synthetic Gap 2026:</p><h4>{GAP_TYPEB_26}</h4><p>Synthetic Gap 2036:</p><h4>{GAP_TYPEB_36}</h4>',
              },
            ]
          },//END OF SECTION
    ...
    CODES: [
      {
        ...
        sections: [
            ...
            layers: [
              {
                ...
                hover: '<p>Project:</p><h4>{PROJECT_NAME}</h4><p>Priority:</p><h4>{PRIORITY} / 18</h4><p>Type:</p><h4>{PROJECT_TYPE}</h4><i>Click for more details</i>',
                click: CLICK_IMPLEMENTATION_PRI_AREA,
              },
              {
                name: 'LGA',
                id: 'SITE_PRIORITY_AREAS_LGA',
                legendText: 'Capacity Increase Priority LGA Areas (Colour: Category)',
                hover: '<p>Project:</p><h4>{PROJECT_NAME}</h4><p>Priority:</p><h4>{PRIORITY} / 18</h4><p>Type:</p><h4>{PROJECT_TYPE}</h4><i>Click for more details</i>',
                click: CLICK_IMPLEMENTATION_PRI_AREA,
              },
              {
                ...
                legendText: 'Capacity Increase Priority SA2 Areas (Colour: Category)',
                hover: '<p>Project:</p><h4>{PROJECT_NAME}</h4><p>Priority:</p><h4>{PRIORITY} / 18</h4><p>Type:</p><h4>{PROJECT_TYPE}</h4><i>Click for more details</i>',
                click: CLICK_IMPLEMENTATION_PRI_AREA,
              },
            ]
          },//END OF SECTION
          {
            ...
            text: SITE_PRIORITIES_TEXT,
            icon: POINT_ICON,
            layers: [
              {
                name: 'SITE',
                id: 'SITE_PRIORITY_SITES',
                legendText: 'Capacity Increase Priority Sites (Colour: Category)',
                hover: '<p>Project:</p><h4>{PROJECT_NAME}</h4><p>Priority:</p><h4>{PRIORITY} / 18</h4><p>Type:</p><h4>{PROJECT_TYPE}</h4><i>Click for more details</i>',
                click: CLICK_IMPLEMENTATION_PRI_SITE,
              },
            ]
          },//END OF SECTION
          {
          ...
          },//END OF SECTION
          {
            ...
            text: null,
            // text: '<span><a href="https://www.activexchange.org" target="_blank" style="text-decoration: underline !important;font-weight:bold;">View Plans</a><span>',
            icon: DOCUMENT_ICON,
            // documentHtml: test,
          },//END OF SEC
          {
